...
local Namespace = vim.api.nvim_create_namespace('vim.exploer')
...
---
---@type table<string, vim._explorer.Explorer>
local Explorers = {}

--- @class vim._explorer.Opts
---
--- Lua Patterns to exclude from the directory view (default: `{}`)
...
---@param explorer vim._explorer.Explorer
---@param paths string[]
...
---@param opts vim._explorer.Opts? When omitted or `nil`, retrieve the current
---       configuration. Otherwise, a configuration table (see |vim._explorer.Opts|).
---@return vim._explorer.Opts? : Current explorer config if {opts} is omitted.
