...
---
---Emits img_data/img_set/img_del UI events to any attached UI that activated
...
---Query whether images can be displayed via UI events, which requires any
---attached UI to have activated the "ext_images" capability.
---@param _opts? {timeout?: integer, chan?: integer} unused by this backend
---@return boolean supported
---@return string? msg
function M.supported(_opts)
  return M.available()
end
