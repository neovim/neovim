...
---
--- Directory markers (".git/", "package.json", …) used to decide `root_dir`. Unused if `root_dir`
--- is provided. The list order decides priority. To indicate "equal priority", specify names in
