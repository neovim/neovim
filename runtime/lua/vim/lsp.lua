...
--- `root_dir`.
---
--- To disable, pass `enable=false`: Stops related clients and servers (and may force-stop servers
--- after a timeout, unless `exit_timeout=false`).
---
--- Examples:
---
--- ```lua
...
--- servers (and may force-stop servers after `exit_timeout` milliseconds).
