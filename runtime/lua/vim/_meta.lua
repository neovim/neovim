...
vim.uri_from_fname = vim.uri.uri_from_fname
vim.uri_from_bufnr = vim.uri.uri_from_bufnr
vim.uri_to_fname = vim.uri.uri_to_fname
vim.uri_to_bufnr = vim.uri.uri_to_bufnr
