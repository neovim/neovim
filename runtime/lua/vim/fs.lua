...
--- @param marker (string|fun(name: string, path: string): boolean|(string|string[]|fun(name: string, path: string): boolean)[]) A marker or a list of markers.
...
function M.root(source, marker)
  ...
  local marker_t = type(marker)
  if marker_t == 'string' or marker_t == 'function' then
