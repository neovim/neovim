...
---
--- Unlike |nvim_set_option_value()| which cannot be passed functions for the option
--- value, |vim.o|, |vim.go|, |vim.bo| and |vim.wo| can be assigned function values.
---
--- Example: >lua
