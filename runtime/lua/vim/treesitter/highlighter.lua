...
function TSHighlighter.new(tree, opts)
  ...
  tree:register_cbs({
    ...
    on_child_added = function(child)
      child:for_each_tree(function(t)
        self._conceal_line = self._conceal_line or self:get_query(t:lang()):query().conceal_line
      end)
    end,
  }, true)
  ...
  self._conceal_line = self._conceal_line or self:get_query(tree:lang()):query().conceal_line
