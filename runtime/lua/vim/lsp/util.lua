...
--- Deprecated, use require'vim.lsp.completion'.get_completion_items instead
---
...
function M.extract_completion_items(result)
  vim.notify_once(
    "vim.lsp.util.extract_completion_items is deprecated. Use require'vim.lsp.completion'.get_completion_items()",
    vim.log.levels.WARN
  )
  return require('vim.lsp.completion').get_completion_items(result)
end
...
function M.text_document_completion_list_to_complete_items(result, prefix)
  vim.notify_once(
    "vim.lsp.util.text_document_completion_list_to_complete_items is deprecated. Use require'vim.lsp.completion'.lsp_to_vim_items()",
    vim.log.levels.WARN
  )
  return require('vim.lsp.completion').lsp_to_vim_items(result, prefix)
end
