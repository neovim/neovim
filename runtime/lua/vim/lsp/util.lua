...
---@return Range2
local function get_line_and_col_from_offset(offset, contents)
  local i = 0
...
function M.convert_signature_help_to_markdown_lines(signature_help, ft, triggers)
  ...
  local contents = {}
  local active_offset ---@type [number, number]|nil
  ...
  if active_offset then
    ...
    list_extend(active_hl, get_line_and_col_from_offset(active_offset[1], contents))
    list_extend(active_hl, get_line_and_col_from_offset(active_offset[2], contents))
  end
