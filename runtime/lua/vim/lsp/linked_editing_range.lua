...
--- Enable or disable a linked editing session globally or for a specific client.
---
--- NOTE: Linked editing is automatically enabled by |vim.lsp.buf_attach_client()|. Below is an
--- example of how to disable linked editing ranges for a given client:
---
--- ```lua
--- vim.lsp.start({
---   name = 'ts_ls',
...
---     vim.lsp.linked_editing_range.enable(false, { client_id = client.id })
---   end,
--- })
--- ```
---
