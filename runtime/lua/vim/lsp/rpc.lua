...
function M.connect(host_or_path, port)
  ...
  return function(dispatchers)
    ...
    local on_read = create_client_read_loop(client, transport.terminate)
...
function M.start(cmd, dispatchers, extra_spawn_params)
  ...
  local transport = lsp_transport.TransportSpawn.new()
  local client = new_client(dispatchers, transport)
  local on_read = create_client_read_loop(client)
  transport:spawn(cmd, extra_spawn_params, on_read, dispatchers.on_exit)
