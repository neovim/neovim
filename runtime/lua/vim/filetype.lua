...
local extension = {
  ...
  EU = function(_, bufnr) return require("vim.filetype.detect").euphoria(_, bufnr) end,
  EW = function(_, bufnr) return require("vim.filetype.detect").euphoria(_, bufnr) end,
  EX = function(_, bufnr) return require("vim.filetype.detect").euphoria(_, bufnr) end,
  EXU = function(_, bufnr) return require("vim.filetype.detect").euphoria(_, bufnr) end,
  EXW = function(_, bufnr) return require("vim.filetype.detect").euphoria(_, bufnr) end,
  PL = function() vim.fn["dist#ft#FTpl"]() end,
  R = function(_, bufnr) require("vim.filetype.detect").r(_, bufnr) end,
  ...
  btm = function(_, bufnr) return require("vim.filetype.detect").btm(_, bufnr) end,
  ...
  ent = function(_, bufnr) return require("vim.filetype.detect").ent(_, bufnr) end,
  env = function() vim.fn["dist#ft#SetFileTypeSH"](vim.fn.getline(1)) end,
  eu = function(_, bufnr) return require("vim.filetype.detect").euphoria(_, bufnr) end,
  ew = function(_, bufnr) return require("vim.filetype.detect").euphoria(_, bufnr) end,
  ex = function(_, bufnr) return require("vim.filetype.detect").ex(_, bufnr) end,
  exu = function(_, bufnr) return require("vim.filetype.detect").euphoria(_, bufnr) end,
  exw = function(_, bufnr) return require("vim.filetype.detect").euphoria(_, bufnr) end,
  frm = function(_, bufnr) require("vim.filetype.detect").frm(_, bufnr) end,
  fs = function() vim.fn["dist#ft#FTfs"]() end,
  h = function(_, bufnr) require("vim.filetype.detect").header(_, bufnr) end,
  ...
  idl = function(_, bufnr) require("vim.filetype.detect").idl(_, bufnr) end,
  inc = function() vim.fn["dist#ft#FTinc"]() end,
  inp = function(_, bufnr) require("vim.filetype.detect").inp(_, bufnr) end,
  ...
  mc = function(_, bufnr) require("vim.filetype.detect").mc(_, bufnr) end,
  mm = function() vim.fn["dist#ft#FTmm"]() end,
  mms = function(_, bufnr) require("vim.filetype.detect").mms(_, bufnr) end,
  ...
  r = function(_, bufnr) require("vim.filetype.detect").r(_, bufnr) end,
  rdf = function(_, bufnr) require("vim.filetype.detect").redif(_, bufnr) end,
  rules = function() vim.fn["dist#ft#FTRules"]() end,
  sc = function(_, bufnr) require("vim.filetype.detect").sc(_, bufnr) end,
  scd = function(_, bufnr) require("vim.filetype.detect").scd(_, bufnr) end,
  sh = function() vim.fn["dist#ft#SetFileTypeSH"](vim.fn.getline(1)) end,
  shtml = function() vim.fn["dist#ft#FThtml"]() end,
  sql = function(_, bufnr) require("vim.filetype.detect").sql(_, bufnr) end,
  ...
  tf = function(path, bufnr) require("vim.filetype.detect").tf(path, bufnr) end,
  w = function(_, bufnr) require("vim.filetype.detect").progress_cweb(_, bufnr) end,
  xml = function(_, bufnr) require("vim.filetype.detect").xml(_, bufnr) end,
  y = function(_, bufnr) require("vim.filetype.detect").y(_, bufnr) end,
  zsql = function(_, bufnr) require("vim.filetype.detect").sql(_, bufnr) end,
...
local filename = {
  ...
  fvSchemes = function(_, bufnr) require("vim.filetype.detect").foam(_, bufnr) end,
  fvSolution = function(_, bufnr) require("vim.filetype.detect").foam(_, bufnr) end,
  fvConstraints = function(_, bufnr) require("vim.filetype.detect").foam(_, bufnr) end,
  fvModels = function(_, bufnr) require("vim.filetype.detect").foam(_, bufnr) end,
  fstab = "fstab",
  mtab = "fstab",
  [".gdbinit"] = "gdb",
  gdbinit = "gdb",
...
local pattern = {
  ...
  ["%.zlog.*"] = starsetf('zsh'),
  ["%.zsh.*"] = starsetf('zsh'),
  [".*%.[1-9]"] = function(_, bufnr) return require("vim.filetype.detect").nroff(_, bufnr) end,
  ...
  ["[a-zA-Z0-9].*Dict"] = function(_, bufnr) require("vim.filetype.detect").foam(_, bufnr) end,
  ["[a-zA-Z0-9].*Dict%..*"] = function(_, bufnr) require("vim.filetype.detect").foam(_, bufnr) end,
  ["[a-zA-Z].*Properties"] = function(_, bufnr) require("vim.filetype.detect").foam(_, bufnr) end,
  ["[a-zA-Z].*Properties%..*"] = function(_, bufnr) require("vim.filetype.detect").foam(_, bufnr) end,
  [".*Transport%..*"] = function(_, bufnr) require("vim.filetype.detect").foam(_, bufnr) end,
  [".*/constant/g"] = function(_, bufnr) require("vim.filetype.detect").foam(_, bufnr) end,
  [".*/0/.*"] = function(_, bufnr) require("vim.filetype.detect").foam(_, bufnr) end,
  [".*/0%.orig/.*"] = function(_, bufnr) require("vim.filetype.detect").foam(_, bufnr) end,
