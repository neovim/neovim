...
---                    file (".conf"). If true, the filetype should be set with `:setf FALLBACK conf`,
---                    which enables a later `:setf` command to override the filetype.
---                    See `:help setf` for more information.
