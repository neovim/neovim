...
local filename = {
  ...
  fvSchemes = function(path, bufnr) require("vim.filetype.detect").foam(path, bufnr) end,
  fvSolution = function(path, bufnr) require("vim.filetype.detect").foam(path, bufnr) end,
  fvConstraints = function(path, bufnr) require("vim.filetype.detect").foam(path, bufnr) end,
  fvModels = function(path, bufnr) require("vim.filetype.detect").foam(path, bufnr) end,
  fstab = "fstab",
  mtab = "fstab",
  [".gdbinit"] = "gdb",
  gdbinit = "gdb",
...
local pattern = {
  ...
  ["[a-zA-Z0-9].*Dict"] = function(path, bufnr) require("vim.filetype.detect").foam(path, bufnr) end,
  ["[a-zA-Z0-9].*Dict%..*"] = function(path, bufnr) require("vim.filetype.detect").foam(path, bufnr) end,
  ["[a-zA-Z].*Properties"] = function(path, bufnr) require("vim.filetype.detect").foam(path, bufnr) end,
  ["[a-zA-Z].*Properties%..*"] = function(path, bufnr) require("vim.filetype.detect").foam(path, bufnr) end,
  [".*Transport%..*"] = function(path, bufnr) require("vim.filetype.detect").foam(path, bufnr) end,
  [".*/constant/g"] = function(path, bufnr) require("vim.filetype.detect").foam(path, bufnr) end,
  [".*/0/.*"] = function(path, bufnr) require("vim.filetype.detect").foam(path, bufnr) end,
  [".*/0%.orig/.*"] = function(path, bufnr) require("vim.filetype.detect").foam(path, bufnr) end,
