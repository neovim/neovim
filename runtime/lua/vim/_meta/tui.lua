...
--- $NVIM_TERMDEFS. These definitions replace corresponding builtin terminfo
--- entries, and the system terminfo (if any) is skipped entirely. For example,
--- to disable alternate screen, override the sequence nvim sends to reset the
--- cursor style, and set the sequences that get interpreted as <Home> and
--- <S-Home>: >
---
---   NVIM_TERMDEFS='{
---     "enter_ca_mode": "",
