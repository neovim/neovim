...
---                   note: total_lines accounts for line wrapping
---                   and folds. use scroll_offset with
---                   |win_text_height()| to map between line
---                   numbers and scroll positions.
---
--- Each item in the scrollbar is a dictionary with the following
--- entries:
---   visible          Whether scrollbar is displayed
---   total_lines  Total screen lines in buffer
