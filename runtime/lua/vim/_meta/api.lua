...
---   - "eol_right_align": display right aligned in the window unless
---                        the virtual text is longer than the space
---                        available. If the virtual text is too long,
---                        it is truncated to fit in the window after
---                        the EOL character.
