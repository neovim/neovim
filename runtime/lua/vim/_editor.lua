...
---@param key string
---@param fn function If the first return value is `false`, the original function is skipped.
---@return table obj with original function and :unwind()
function vim.on_fun(container, key, fn)
