...
function M.enable_mappings()
  vim.keymap.set('n', '<Plug>(MatchitNormalForward)', function()
    M.jump(true, 'n')
  end, { silent = true })
  vim.keymap.set('n', '<Plug>(MatchitNormalBackward)', function()
    M.jump(false, 'n')
  end, { silent = true })
  vim.keymap.set('x', '<Plug>(MatchitVisualForward)', function()
    M.jump(true, 'v')
  end, { silent = true })
  vim.keymap.set('x', '<Plug>(MatchitVisualBackward)', function()
    M.jump(false, 'v')
  end, { silent = true })
  vim.keymap.set('o', '<Plug>(MatchitOperationForward)', function()
    M.jump(true, 'o')
  end, { silent = true })
  vim.keymap.set('o', '<Plug>(MatchitOperationBackward)', function()
    M.jump(false, 'o')
  end, { silent = true })
  vim.keymap.set('n', '<Plug>(MatchitNormalMultiBackward)', function()
    M.multi_match('bW', 'n')
  end, { silent = true })
  ...
  vim.keymap.set('o', '<Plug>(MatchitOperationMultiForward)', function()
    M.multi_match('W', 'o')
  end, { silent = true })
  vim.keymap.set(
    'x',
...
function M.enable()
  ...
  M.enable_mappings()
  api.nvim_create_user_command('MatchDisable', M.disable, { force = true })
  api.nvim_create_user_command('MatchEnable', M.enable_mappings, { force = true })
end
