...
call <SID>AddOption("undokeep", gettext("keep undo history on external file change"))
call <SID>BinOptionG("udk", &udk)
call <SID>AddOption("undokeepdir", gettext("list of directories for snapshot files"))
call <SID>OptionG("udkdir", &udkdir)
