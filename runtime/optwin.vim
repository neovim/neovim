...
call append("$", "margin\tcolumns and rows between the text and the line number or window edges")
call append("$", "start\tnumber of columns before the start of the text line")
call append("$", "\tset margin=start:")
call append("$", "end\tnumber of columns after the end of the text line")
call append("$", "\tset margin=end:")
call append("$", "end\tnumber of rows before the first visible line of text")
call append("$", "\tset margin=top:")
call append("$", "end\tnumber of rows after the last visible line of text")
call append("$", "\tset margin=bottom:")
call append("$", "all values can be set by passing a number in instead")
call append("$", "\tset margin=<num>")
call append("$", "a specifying a specific margin after passing a number is valid")
call append("$", "\tset margin=<num>,top:")
call append("$", "\t(local to window)")
call <SID>OptionL("mrg")
if has("conceal")
