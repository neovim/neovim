...
call <SID>AddOption("breakindentopt", gettext("adjust breakindent behavior"))
call append("$", "\t" .. s:local_to_window)
...
call <SID>AddOption("tabclose", gettext("behavior when closing tab pages: left, uselast or empty"))
