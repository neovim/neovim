...
### Build offline with "bundled" dependencies (USE_EXISTING_SRC_DIR)

On systems with old or missing libraries, you may want to build *with* bundled
dependencies, *without* network access. This is supported as follows.
