...
#define LOG_CHARACTER(message, character)                                      \
  LOG(32 <= character && character < 127 ? message " character:'%c'"           \
                                         : message " character:%d",            \
      character)
...
typedef utf8proc_ssize_t (*DecodeFunction)(const utf8proc_uint8_t *,
                                           utf8proc_ssize_t,
                                           utf8proc_int32_t *);
...
static void ts_lexer__get_lookahead(Lexer *self)
{
  ...
  DecodeFunction decode = self->input.encoding == TSInputEncodingUTF8
                              ? utf8proc_iterate
                              : utf16_iterate;
...
void ts_lexer_set_included_ranges(Lexer *self,
