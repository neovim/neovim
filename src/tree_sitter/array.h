...
#define array_insert(self, index, element)                                     \
  array__splice((VoidArray *)(self), array__elem_size(self), index, 0, 1,      \
                &element)

#define array_pop(self) ((self)->contents[--(self)->size])

#define array_assign(self, other)                                              \
  array__assign((VoidArray *)(self), (const VoidArray *)(other),               \
...
static inline void array__erase(VoidArray *self,
                                size_t element_size,
                                uint32_t index)
{
...
static inline void array__reserve(VoidArray *self,
                                  size_t element_size,
...
static inline void array__assign(VoidArray *self,
...
static inline void array__grow(VoidArray *self,
                               size_t count,
                               size_t element_size)
{
