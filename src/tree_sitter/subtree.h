...
void ts_external_scanner_state_init(ExternalScannerState *,
                                    const char *,
                                    unsigned);
...
Subtree ts_subtree_new_leaf(SubtreePool *,
                            TSSymbol,
                            Length,
                            Length,
                            uint32_t,
                            ...
                            bool,
                            const TSLanguage *);
Subtree ts_subtree_new_error(SubtreePool *,
                             int32_t,
                             Length,
                             Length,
                             uint32_t,
                             TSStateId,
                             const TSLanguage *);
MutableSubtree ts_subtree_new_node(SubtreePool *,
                                   TSSymbol,
                                   SubtreeArray *,
                                   unsigned,
                                   const TSLanguage *);
Subtree ts_subtree_new_error_node(SubtreePool *,
                                  SubtreeArray *,
                                  bool,
                                  const TSLanguage *);
Subtree ts_subtree_new_missing_leaf(SubtreePool *,
                                    TSSymbol,
                                    Length,
                                    const TSLanguage *);
...
void ts_subtree_set_children(MutableSubtree,
                             Subtree *,
                             uint32_t,
                             const TSLanguage *);
