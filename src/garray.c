...
/**
 * Concatenate a growable array of strings by ","
 *
 * A newly allocated string will be returned.
 *
 * It's a bug to call this function if the array doesn't contains strings.
 *
 * Examples:
 *   NULL -> NULL
 *   [] -> NULL
