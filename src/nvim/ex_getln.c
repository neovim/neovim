...
void cmdwin_do_action(const char *action)
{
  ...
  nlua_call_vimfn("vim._core.cmdwin", action, tv_args, NULL);
}
...
static int open_cmdwin(void)
{
  ...
  // Synchronously pass the snapshot to Lua. nlua_call_vimfn marshalls args into Lua-owned copies,
  ...
  nlua_call_vimfn("vim._core.cmdwin", "_schedule_open", tv_args, NULL);
