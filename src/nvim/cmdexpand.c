...
int showmatches(expand_T *xp, bool wildmenu)
{
  ...
  // Cmdline completion popup menu with ext_wildmenu, or wildoptions=pum and
  // no ext_cmdline, or ext_popupmenu, or cmdline_win set (_cmdline_offset).
  if (ui_has(kUIWildmenu) || ((!ui_has(kUICmdline) || ui_has(kUIPopupmenu) || cmdline_win != NULL)
