                        ...
                        void *cookie)
{
  ...
  if (p != NULL && ea.cmdidx == CMD_SIZE && !ea.skip
    ...
    int ret = apply_autocmds(EVENT_CMDUNDEFINED, cmdname, cmdname, true, NULL, curwin);
    xfree(cmdname);
...
bool before_quit_autocmds(win_T *wp, bool quit_all, bool forceit)
{
  ...
  if (quit_all
    ...
    // Same window as QuitPre above: the one whose quit makes Nvim exit.
    apply_autocmds(EVENT_EXITPRE, NULL, NULL, false, curbuf, wp);
