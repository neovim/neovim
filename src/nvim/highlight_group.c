...
static const char *highlight_init_light[] = {
  ...
  "PmenuMatch           guifg=NvimLightBLue  guibg=NvimDarkGrey2             cterm=bold,ctermfg=12",
...
static const char *highlight_init_dark[] = {
  ...
  "PmenuMatch           guifg=NvimDarkBlue    guibg=NvimLightGrey2 gui=bold cterm=bold ctermfg=4",
