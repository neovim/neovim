...
static const char *highlight_init_both[] = {
  ...
  "default link @diff.plus.line  DiffLineAdd",
  "default link @diff.minus.line DiffLineDelete",
...
static const char *highlight_init_light[] = {
  ...
  "DiffLineAdd                               guibg=NvimLightGreen                       ctermbg=2",
  "DiffLineDelete                            guibg=NvimLightRed                         ctermbg=1",
...
static const char *highlight_init_dark[] = {
  ...
  "DiffLineAdd                                guibg=NvimDarkGreen                      ctermbg=10",
  "DiffLineDelete                             guibg=NvimDarkRed                        ctermbg=9",
