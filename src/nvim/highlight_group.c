...
static const char *highlight_init_light[] = {
  ...
  "Pmenu        ctermbg=LightGrey ctermfg=Black guibg=LightGrey guifg=Black",
  "PmenuSel     ctermbg=DarkGrey ctermfg=White guibg=DarkGrey guifg=White",
...
static const char *highlight_init_dark[] = {
  ...
  "Pmenu        ctermbg=DarkGrey ctermfg=White guibg=DarkGrey guifg=White",
  "PmenuSel     ctermbg=LightGrey ctermfg=Black guibg=LightGrey guifg=Black",
