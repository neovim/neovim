...
static const char *highlight_init_light[] = {
  ...
  "CursorLine                                guibg=NvimLightGrey1",
  ...
  "Folded               guifg=NvimDarkGrey4  guibg=NvimLightGrey4",
...
static const char *highlight_init_dark[] = {
  ...
  "CursorLine                                 guibg=NvimDarkGrey1",
  ...
  "Folded               guifg=NvimLightGrey4  guibg=NvimDarkGrey4",
