...
static const char *highlight_init_both[] = {
  ...
  "default link @lsp.kind.method        @lsp.type.method",
  "default link @lsp.kind.function      @lsp.type.function",
  "default link @lsp.kind.constructor   @constructor",
  "default link @lsp.kind.field         @lsp.type.property",
  "default link @lsp.kind.variable      @lsp.type.variable",
  "default link @lsp.kind.class         @lsp.type.class",
  "default link @lsp.kind.interface     @lsp.type.interface",
  "default link @lsp.kind.module        @lsp.type.namespace",
  "default link @lsp.kind.property      @lsp.type.property",
  "default link @lsp.kind.unit          Pmenu",
  "default link @lsp.kind.value         Pmenu",
  "default link @lsp.kind.enum          @lsp.type.enum",
  "default link @lsp.kind.keyword       @lsp.type.keyword",
  "default link @lsp.kind.snippet       Pmenu",
  "default link @lsp.kind.color         Pmenu",
  "default link @lsp.kind.file          Pmenu",
  "default link @lsp.kind.reference     Pmenu",
  "default link @lsp.kind.folder        Pmenu",
  "default link @lsp.kind.enumMember    @lsp.type.enumMember",
  "default link @lsp.kind.constant      Constant",
  "default link @lsp.kind.struct        @lsp.type.struct",
  "default link @lsp.kind.event         @lsp.type.event",
  "default link @lsp.kind.operator      @lsp.type.operator",
  "default link @lsp.kind.typeParameter @lsp.type.typeParameter",
