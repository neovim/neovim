...
static const char *highlight_init_light[] = {
  ...
  "DiffhlAdd            guifg=NvimDarkGrey1  guibg=NvimLightGreen            ctermfg=15 ctermbg=2",
  "DiffhlDelete         guifg=NvimDarkGrey1  guibg=NvimLightRed              ctermfg=15 ctermbg=1",
...
static const char *highlight_init_dark[] = {
  ...
  "DiffhlAdd            guifg=NvimLightGrey1  guibg=NvimDarkGreen           ctermfg=0 ctermbg=10",
  "DiffhlDelete         guifg=NvimLightGrey1  guibg=NvimDarkRed             ctermfg=0 ctermbg=9",
