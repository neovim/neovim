...
return {
  funcs={
    ...
    changenr={},
    chanclose={args={1, 2}, base=1},
    chansend={args=2, base=1},
    ...
    dictwatcheradd={args=3, base=1},
    dictwatcherdel={args=3, base=1},
    did_filetype={},
    ...
    id={args=1},
    items={args=1, base=1},
    jobclose={args={1, 2}, base=1, func="f_chanclose"},
    jobpid={args=1, base=1},
    jobresize={args=3, base=1},
    jobsend={args=2, base=1, func="f_chansend"},
    jobstart={args={1, 2}, base=1},
    jobstop={args=1, base=1},
    jobwait={args={1, 2}, base=1},
    ...
    max={args=1, base=1},
    menu_get={args={1, 2}, base=1},
    min={args=1, base=1},
    mkdir={args={1, 3}},
    mode={args={0, 1}},
    msgpackdump={args=1, base=1},
    msgpackparse={args=1, base=1},
    nextnonblank={args=1},
    nr2char={args={1, 2}},
    ['or']={args=2, base=1},
    pathshorten={args=1},
    ...
    rpcnotify={args=varargs(2), base=1},
    rpcrequest={args=varargs(2), base=1},
    rpcstart={args={1, 2}},
    rpcstop={args=1},
    rubyeval={args=1},
    screenattr={args=2},
