...
///
/// @param[in]  buf        Pointer to the buffer (buf_T) where the text will be set.
/// @param[in]  info       Informational text to display in the preview buffer.
/// @param[in]  lnum       Pointer to a line number (linenr_T), indicating where to start the text.
/// @param[out] max_width  Pointer to an integer to store the maximum width of the displayed text.
