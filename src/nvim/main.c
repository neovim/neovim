...
static void usage(void)
{
  ...
  mch_msg(_("  -E                    "
            "Improved Ex mode\n"));
  mch_msg(_("  -s                    "
            "Silent (batch) mode (only for ex mode)\n"));
  mch_msg(_("  -d                    "
            "Diff mode\n"));
  mch_msg(_("  -R                    "
            "Read-only mode\n"));
  mch_msg(_("  -Z                    "
            "Restricted mode\n"));
  mch_msg(_("  -m                    "
            "Modifications (writing files) not allowed\n"));
  mch_msg(_("  -M                    "
            "Modifications in text not allowed\n"));
  mch_msg(_("  -b                    "
            "Binary mode\n"));
  mch_msg(_("  -l                    "
            "Lisp mode\n"));
  ...
  mch_msg(_("  -H                    "
            "Hebrew mode\n"));
  mch_msg(_("  -V[N][file]           "
            "Be verbose [level N][log messages to file]\n"));
  mch_msg(_("  -D                    "
            "Debugging mode\n"));
  mch_msg(_("  -n                    "
  ...
  mch_msg(_("  +<linenum>            "
            "Start at line <linenum>\n"));
  mch_msg(_("  +/<pattern>           "
            "Start at first occurrence of <pattern>\n"));
  mch_msg(_("  --cmd <command>       "
            "Execute <command> before loading any vimrc\n"));
  mch_msg(_("  -c <command>          "
            "Execute <command> after loading the first file\n"));
  mch_msg(_("  -S <session>          "
            "Source <session> after loading the first file\n"));
  mch_msg(_("  -s <scriptin>         "
            "Read Normal mode commands from <scriptin>\n"));
  mch_msg(_("  -w <scriptout>        "
            "Append all typed characters to <scriptout>\n"));
  mch_msg(_("  -W <scriptout>        "
            "Write all typed characters to <scriptout>\n"));
  mch_msg(_("  --startuptime <file>  "
