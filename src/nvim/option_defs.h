...
static char *(p_bo_values[])
    = {"all",        "backspace", "cursor", "complete",  "copy",
...
static char *(p_fdo_values[])
    = {"all",    "block", "hor",    "mark", "percent", "quickfix",
...
static char *(p_rdb_values[])
    = {"compositor", "nothrottle", "invalid", "nodelta", NULL};
#endif
...
static char *(p_ssop_values[])
    = {"buffers",  "winpos", "resize", "winsize", "localoptions",
