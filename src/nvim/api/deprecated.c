  ...
  FUNC_API_SINCE(1)
{
  ...
  Object line_obj = INTEGER_OBJ(0);
  Object col_obj = INTEGER_OBJ(0);
  ...
  FUNC_API_SINCE(8)
{
  ...
  Object line_obj = INTEGER_OBJ(0);
  Object col_obj = INTEGER_OBJ(0);
  Object buf_obj = INTEGER_OBJ(0);
  Object file_obj = CSTR_AS_OBJ("");
