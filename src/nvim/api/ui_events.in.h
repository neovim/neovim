...
void win_float_pos(Integer grid,
                   ...
                   Float anchor_row,
                   Float anchor_col,
                   Boolean focusable) FUNC_API_SINCE(6) FUNC_API_REMOTE_ONLY;
...
void win_viewport(Integer grid,
                  ...
                  Integer botline,
                  Integer curline,
                  Integer curcol) FUNC_API_SINCE(7) FUNC_API_REMOTE_ONLY;

void popupmenu_show(Array items,
                    Integer selected,
                    Integer row,
                    Integer col,
                    Integer grid) FUNC_API_SINCE(3) FUNC_API_REMOTE_ONLY;
