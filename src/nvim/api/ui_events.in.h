...
void default_colors_set(Integer rgb_fg,
                        ...
                        Integer rgb_sp,
                        Integer cterm_fg,
                        Integer cterm_bg) FUNC_API_SINCE(4) FUNC_API_REMOTE_IMPL;
...
void grid_scroll(Integer grid,
                 ...
                 Integer right,
                 Integer rows,
                 Integer cols) FUNC_API_SINCE(5) FUNC_API_REMOTE_IMPL FUNC_API_COMPOSITOR_IMPL;
...
void raw_line(Integer grid,
              ...
              LineFlags flags,
              const schar_T *chunk,
              const sattr_T *attrs) FUNC_API_NOEXPORT FUNC_API_COMPOSITOR_IMPL;
...
void win_pos(Integer grid,
             ...
             Integer startcol,
             Integer width,
             Integer height) FUNC_API_SINCE(6) FUNC_API_REMOTE_ONLY;
void win_float_pos(Integer grid,
                   ...
                   Float anchor_col,
                   Boolean focusable,
                   Integer zindex) FUNC_API_SINCE(6) FUNC_API_REMOTE_ONLY;
...
void win_viewport(Integer grid,
                  ...
                  Integer curline,
                  Integer curcol,
                  Integer line_count) FUNC_API_SINCE(7) FUNC_API_REMOTE_ONLY;
...
void cmdline_show(Array content,
                  ...
                  String prompt,
                  Integer indent,
                  Integer level) FUNC_API_SINCE(3) FUNC_API_REMOTE_ONLY;
