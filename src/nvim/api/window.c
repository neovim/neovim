...
/// Sets the current buffer in a window. This allows switching the buffer of
/// any window from within any other window without triggering side effects
/// usually associated with switching between windows, such as triggering
/// autocommands.
///
/// @param window   Window handle
