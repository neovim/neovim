...
RawLineReturn grid_line_to_raw_line(Array args)
{
  ...
  ADD(arr, INTEGER_OBJ(grid));
  ADD(arr, INTEGER_OBJ(row));
  ADD(arr, INTEGER_OBJ(startcol));
  ADD(arr, INTEGER_OBJ(endcol));
  ADD(arr, INTEGER_OBJ(clearcol));
