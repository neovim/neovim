...
DECLARE_TYPVAL_ENCODE_CHECK_SELF_REFERENCE(static, object, EncodedData * const, edata)
DEFINE_TYPVAL_ENCODE_CHECK_SELF_REFERENCE(static, object, EncodedData * const, edata)
DECLARE_TYPVAL_ENCODE_CONVERT_ONE_VALUE(static, object, EncodedData * const, edata)
DEFINE_TYPVAL_ENCODE_CONVERT_ONE_VALUE(static, object, EncodedData * const, edata)
DECLARE_TYPVAL_ENCODE_ENCODE(static, object, EncodedData *const, edata)
DEFINE_TYPVAL_ENCODE_ENCODE(static, object, EncodedData *const, edata)
