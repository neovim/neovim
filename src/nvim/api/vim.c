...
/// ranges etc
void nvim__put_attr(Integer id, Integer prio, Integer start_row, Integer start_col,
  ...
  FUNC_API_LUA_ONLY
{
  ...
  decorations_add_luahl_attr(attr, (int)prio, (int)start_row, (colnr_T)start_col,
