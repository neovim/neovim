...
#else
#define STATIC_ASSERT_PRAGMA_START                                                                 \
  _Pragma("GCC diagnostic push") _Pragma("GCC diagnostic ignored \"-pedantic\"")
#endif
...
#undef STATIC_ASSERT_PRAGMA_START
#define STATIC_ASSERT_PRAGMA_START                                                                 \
  _Pragma("clang diagnostic push") _Pragma("clang diagnostic ignored \"-Wc11-extensions\"")
...
#define STATIC_ASSERT_EXPR(e, m)                                                                   \
  ((enum {                                                                                         \
      ASSERT_CONCAT(static_assert_, __COUNTER__) = 1 / (!!(e)),                                    \
  })0)
#else
