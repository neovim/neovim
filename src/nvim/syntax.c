...
color_name_table_T color_name_table[] = {
  ...
  {"Maroon", NVIM_RGB(0x80, 0x00, 0x00)},
  {"DarkRed", NVIM_RGB(0x8b, 0x00, 0x00)},
  {"Brown", NVIM_RGB(0xa5, 0x2a, 0x2a)},
  {"Firebrick", NVIM_RGB(0xb2, 0x22, 0x22)},
  {"Crimson", NVIM_RGB(0xdc, 0x14, 0x3c)},
  {"Red", NVIM_RGB(0xff, 0x00, 0x00)},
  {"Tomato", NVIM_RGB(0xff, 0x63, 0x47)},
  {"Coral", NVIM_RGB(0xff, 0x7f, 0x50)},
  {"IndianRed", NVIM_RGB(0xcd, 0x5c, 0x5c)},
  {"LightCoral", NVIM_RGB(0xf0, 0x80, 0x80)},
  {"DarkSalmon", NVIM_RGB(0xe9, 0x96, 0x7a)},
  {"Salmon", NVIM_RGB(0xfa, 0x80, 0x72)},
  {"LightSalmon", NVIM_RGB(0xff, 0xa0, 0x7a)},
  {"OrangeRed", NVIM_RGB(0xff, 0x45, 0x00)},
  {"DarkOrange", NVIM_RGB(0xff, 0x8c, 0x00)},
  {"Orange", NVIM_RGB(0xff, 0xa5, 0x00)},
  {"Gold", NVIM_RGB(0xff, 0xd7, 0x00)},
  {"DarkGoldenRod", NVIM_RGB(0xb8, 0x86, 0x0b)},
  {"GoldenRod", NVIM_RGB(0xda, 0xa5, 0x20)},
  {"PaleGoldenRod", NVIM_RGB(0xee, 0xe8, 0xaa)},
  {"DarkKhaki", NVIM_RGB(0xbd, 0xb7, 0x6b)},
  {"Khaki", NVIM_RGB(0xf0, 0xe6, 0x8c)},
  {"Olive", NVIM_RGB(0x80, 0x80, 0x00)},
  {"Yellow", NVIM_RGB(0xff, 0xff, 0x00)},
  {"YellowGreen", NVIM_RGB(0x9a, 0xcd, 0x32)},
  {"DarkOliveGreen", NVIM_RGB(0x55, 0x6b, 0x2f)},
  {"OliveDrab", NVIM_RGB(0x6b, 0x8e, 0x23)},
  {"LawnGreen", NVIM_RGB(0x7c, 0xfc, 0x00)},
  {"ChartReuse", NVIM_RGB(0x7f, 0xff, 0x00)},
  {"GreenYellow", NVIM_RGB(0xad, 0xff, 0x2f)},
  {"DarkGreen", NVIM_RGB(0x00, 0x64, 0x00)},
  {"Green", NVIM_RGB(0x00, 0x80, 0x00)},
  {"ForestGreen", NVIM_RGB(0x22, 0x8b, 0x22)},
  {"Lime", NVIM_RGB(0x00, 0xff, 0x00)},
  {"LimeGreen", NVIM_RGB(0x32, 0xcd, 0x32)},
  {"LightGreen", NVIM_RGB(0x90, 0xee, 0x90)},
  {"PaleGreen", NVIM_RGB(0x98, 0xfb, 0x98)},
  {"DarkSeaGreen", NVIM_RGB(0x8f, 0xbc, 0x8f)},
  {"MediumSpringGreen", NVIM_RGB(0x00, 0xfa, 0x9a)},
  {"SpringGreen", NVIM_RGB(0x00, 0xff, 0x7f)},
  {"SeaGreen", NVIM_RGB(0x2e, 0x8b, 0x57)},
  {"MediumAquamarine", NVIM_RGB(0x66, 0xcd, 0xaa)},
  {"MediumSeaGreen", NVIM_RGB(0x3c, 0xb3, 0x71)},
  {"LightSeaGreen", NVIM_RGB(0x20, 0xb2, 0xaa)},
  {"DarkSlateGray", NVIM_RGB(0x2f, 0x4f, 0x4f)},
  {"Teal", NVIM_RGB(0x00, 0x80, 0x80)},
  {"DarkCyan", NVIM_RGB(0x00, 0x8b, 0x8b)},
  {"Aqua", NVIM_RGB(0x00, 0xff, 0xff)},
  {"Cyan", NVIM_RGB(0x00, 0xff, 0xff)},
  {"LightCyan", NVIM_RGB(0xe0, 0xff, 0xff)},
  {"DarkTurquoise", NVIM_RGB(0x00, 0xce, 0xd1)},
  {"Turquoise", NVIM_RGB(0x40, 0xe0, 0xd0)},
  {"MediumTurquoise", NVIM_RGB(0x48, 0xd1, 0xcc)},
  {"PaleTurquoise", NVIM_RGB(0xaf, 0xee, 0xee)},
  {"Aquamarine", NVIM_RGB(0x7f, 0xff, 0xd4)},
  {"PowderBlue", NVIM_RGB(0xb0, 0xe0, 0xe6)},
  {"CadetBlue", NVIM_RGB(0x5f, 0x9e, 0xa0)},
  {"SteelBlue", NVIM_RGB(0x46, 0x82, 0xb4)},
  {"CornFlowerBlue", NVIM_RGB(0x64, 0x95, 0xed)},
  {"DeepSkyBlue", NVIM_RGB(0x00, 0xbf, 0xff)},
  {"DodgerBlue", NVIM_RGB(0x1e, 0x90, 0xff)},
  {"LightBlue", NVIM_RGB(0xad, 0xd8, 0xe6)},
  {"SkyBlue", NVIM_RGB(0x87, 0xce, 0xeb)},
  {"LightSkyBlue", NVIM_RGB(0x87, 0xce, 0xfa)},
  {"MidnightBlue", NVIM_RGB(0x19, 0x19, 0x70)},
  {"Navy", NVIM_RGB(0x00, 0x00, 0x80)},
  {"DarkBlue", NVIM_RGB(0x00, 0x00, 0x8b)},
  {"MediumBlue", NVIM_RGB(0x00, 0x00, 0xcd)},
  {"Blue", NVIM_RGB(0x00, 0x00, 0xff)},
  {"RoyalBlue", NVIM_RGB(0x41, 0x69, 0xe1)},
  {"BlueViolet", NVIM_RGB(0x8a, 0x2b, 0xe2)},
  {"Indigo", NVIM_RGB(0x4b, 0x00, 0x82)},
  {"DarkSlateBlue", NVIM_RGB(0x48, 0x3d, 0x8b)},
  {"SlateBlue", NVIM_RGB(0x6a, 0x5a, 0xcd)},
  {"MediumSlateBlue", NVIM_RGB(0x7b, 0x68, 0xee)},
  {"MediumPurple", NVIM_RGB(0x93, 0x70, 0xdb)},
  {"DarkMagenta", NVIM_RGB(0x8b, 0x00, 0x8b)},
  {"DarkViolet", NVIM_RGB(0x94, 0x00, 0xd3)},
  {"DarkOrchid", NVIM_RGB(0x99, 0x32, 0xcc)},
  {"MediumOrchid", NVIM_RGB(0xba, 0x55, 0xd3)},
  {"Purple", NVIM_RGB(0x80, 0x00, 0x80)},
  {"Thistle", NVIM_RGB(0xd8, 0xbf, 0xd8)},
  {"Plum", NVIM_RGB(0xdd, 0xa0, 0xdd)},
  {"Violet", NVIM_RGB(0xee, 0x82, 0xee)},
  {"Magenta", NVIM_RGB(0xff, 0x00, 0xff)},
  {"Fuchsia", NVIM_RGB(0xff, 0x00, 0xff)},
  {"Orchid", NVIM_RGB(0xda, 0x70, 0xd6)},
  {"MediumVioletRed", NVIM_RGB(0xc7, 0x15, 0x85)},
  {"PaleVioletRed", NVIM_RGB(0xdb, 0x70, 0x93)},
  {"DeepPink", NVIM_RGB(0xff, 0x14, 0x93)},
  {"HotPink", NVIM_RGB(0xff, 0x69, 0xb4)},
  {"LightPink", NVIM_RGB(0xff, 0xb6, 0xc1)},
  {"Pink", NVIM_RGB(0xff, 0xc0, 0xcb)},
  {"AntiqueWhite", NVIM_RGB(0xfa, 0xeb, 0xd7)},
  {"Beige", NVIM_RGB(0xf5, 0xf5, 0xdc)},
  {"Bisque", NVIM_RGB(0xff, 0xe4, 0xc4)},
  {"BlanchedAlmond", NVIM_RGB(0xff, 0xeb, 0xcd)},
  {"Wheat", NVIM_RGB(0xf5, 0xde, 0xb3)},
  {"Cornsilk", NVIM_RGB(0xff, 0xf8, 0xdc)},
  {"LemonChiffon", NVIM_RGB(0xff, 0xfa, 0xcd)},
  {"LightGoldenRodYellow", NVIM_RGB(0xfa, 0xfa, 0xd2)},
  {"LightYellow", NVIM_RGB(0xff, 0xff, 0xe0)},
  {"SaddleBrown", NVIM_RGB(0x8b, 0x45, 0x13)},
  {"Sienna", NVIM_RGB(0xa0, 0x52, 0x2d)},
  {"Chocolate", NVIM_RGB(0xd2, 0x69, 0x1e)},
  {"Peru", NVIM_RGB(0xcd, 0x85, 0x3f)},
  {"SandyBrown", NVIM_RGB(0xf4, 0xa4, 0x60)},
  {"BurlyWood", NVIM_RGB(0xde, 0xb8, 0x87)},
  {"Tan", NVIM_RGB(0xd2, 0xb4, 0x8c)},
  {"RosyBrown", NVIM_RGB(0xbc, 0x8f, 0x8f)},
  {"Moccasin", NVIM_RGB(0xff, 0xe4, 0xb5)},
  {"NavajoWhite", NVIM_RGB(0xff, 0xde, 0xad)},
  {"PeachPuff", NVIM_RGB(0xff, 0xda, 0xb9)},
  {"MistyRose", NVIM_RGB(0xff, 0xe4, 0xe1)},
  {"LavenderBlush", NVIM_RGB(0xff, 0xf0, 0xf5)},
  {"Linen", NVIM_RGB(0xfa, 0xf0, 0xe6)},
  {"Oldlace", NVIM_RGB(0xfd, 0xf5, 0xe6)},
  {"PapayaWhip", NVIM_RGB(0xff, 0xef, 0xd5)},
  {"SeaShell", NVIM_RGB(0xff, 0xf5, 0xee)},
  {"MintCream", NVIM_RGB(0xf5, 0xff, 0xfa)},
  {"SlateGray", NVIM_RGB(0x70, 0x80, 0x90)},
  {"LightSlateGray", NVIM_RGB(0x77, 0x88, 0x99)},
  {"LightSteelBlue", NVIM_RGB(0xb0, 0xc4, 0xde)},
  {"Lavender", NVIM_RGB(0xe6, 0xe6, 0xfa)},
  {"FloralWhite", NVIM_RGB(0xff, 0xfa, 0xf0)},
  {"AliceBlue", NVIM_RGB(0xf0, 0xf8, 0xff)},
  {"GhostWhite", NVIM_RGB(0xf8, 0xf8, 0xff)},
  {"Honeydew", NVIM_RGB(0xf0, 0xff, 0xf0)},
  {"Ivory", NVIM_RGB(0xff, 0xff, 0xf0)},
  {"Azure", NVIM_RGB(0xf0, 0xff, 0xff)},
  {"Snow", NVIM_RGB(0xff, 0xfa, 0xfa)},
  {"Black", NVIM_RGB(0x00, 0x00, 0x00)},
  {"DimGray", NVIM_RGB(0x69, 0x69, 0x69)},
  {"DimGrey", NVIM_RGB(0x69, 0x69, 0x69)},
  {"Gray", NVIM_RGB(0x80, 0x80, 0x80)},
  {"Grey", NVIM_RGB(0x80, 0x80, 0x80)},
  {"DarkGray", NVIM_RGB(0xa9, 0xa9, 0xa9)},
  {"DarkGrey", NVIM_RGB(0xa9, 0xa9, 0xa9)},
  {"Silver", NVIM_RGB(0xc0, 0xc0, 0xc0)},
  {"LightGray", NVIM_RGB(0xd3, 0xd3, 0xd3)},
  {"LightGrey", NVIM_RGB(0xd3, 0xd3, 0xd3)},
  {"Gainsboro", NVIM_RGB(0xdc, 0xdc, 0xdc)},
  {"WhiteSmoke", NVIM_RGB(0xf5, 0xf5, 0xf5)},
  {"White", NVIM_RGB(0xff, 0xff, 0xff)},
  // The color names below were taken from gui_x11.c in vim source 
  {"LightRed", NVIM_RGB(0xff, 0xbb, 0xbb)},
  {"LightMagenta",NVIM_RGB(0xff, 0xbb, 0xff)},
  {"DarkYellow", NVIM_RGB(0xbb, 0xbb, 0x00)},
  {"Gray10", NVIM_RGB(0x1a, 0x1a, 0x1a)},
  {"Grey10", NVIM_RGB(0x1a, 0x1a, 0x1a)},
  {"Gray20", NVIM_RGB(0x33, 0x33, 0x33)},
  {"Grey20", NVIM_RGB(0x33, 0x33, 0x33)},
  {"Gray30", NVIM_RGB(0x4d, 0x4d, 0x4d)},
  {"Grey30", NVIM_RGB(0x4d, 0x4d, 0x4d)},
  {"Gray40", NVIM_RGB(0x66, 0x66, 0x66)},
  {"Grey40", NVIM_RGB(0x66, 0x66, 0x66)},
  {"Gray50", NVIM_RGB(0x7f, 0x7f, 0x7f)},
  {"Grey50", NVIM_RGB(0x7f, 0x7f, 0x7f)},
  {"Gray60", NVIM_RGB(0x99, 0x99, 0x99)},
  {"Grey60", NVIM_RGB(0x99, 0x99, 0x99)},
  {"Gray70", NVIM_RGB(0xb3, 0xb3, 0xb3)},
  {"Grey70", NVIM_RGB(0xb3, 0xb3, 0xb3)},
  {"Gray80", NVIM_RGB(0xcc, 0xcc, 0xcc)},
  {"Grey80", NVIM_RGB(0xcc, 0xcc, 0xcc)},
  {"Gray90", NVIM_RGB(0xe5, 0xe5, 0xe5)},
  {"Grey90", NVIM_RGB(0xe5, 0xe5, 0xe5)},
  {NULL, 0},
};
