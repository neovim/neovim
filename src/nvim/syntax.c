...
static const char *highlight_init_both[] = {
  ...
  "default DiagnosticNote ctermfg=7 guifg=LightGrey",
  ...
  "default DiagnosticUnderlineNote cterm=underline gui=underline guisp=LightGrey",
  ...
  "default link DiagnosticVirtualTextNote DiagnosticNote",
