...
#define MAXWLEN                                                                \
  254  // Assume max. word len is this many bytes.
...
#define WF_PFX_COMPPERMIT                                                      \
  (WFP_COMPPERMIT << 24)  // postponed prefix with
                          // COMPOUNDPERMITFLAG
#define WF_PFX_COMPFORBID                                                      \
  (WFP_COMPFORBID << 24)  // postponed prefix with
                          // COMPOUNDFORBIDFLAG
...
#define SPELL_TOUPPER(c)                                                       \
  ((c) >= 128 ? mb_toupper(c) : (int)spelltab.st_upper[c])
