...
void free_buf_options(buf_T *buf, bool free_p_ff)
{
  ...
  clear_string_option(&buf->b_p_kmp);
  ...
  clear_string_option(&buf->b_s.b_p_isk);
  ...
  clear_string_option(&buf->b_p_gfm);
  clear_string_option(&buf->b_p_gp);
  clear_string_option(&buf->b_p_mp);
  clear_string_option(&buf->b_p_efm);
  clear_string_option(&buf->b_p_ep);
  clear_string_option(&buf->b_p_pa);
  clear_string_option(&buf->b_p_tag);
