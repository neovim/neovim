...
/// If `win` is NULL, find a window that uses `buf` and use it. If the current buffer is not in any
/// visible window, put it in a temporary floating window using an entry in `aucmd_win[]`.
