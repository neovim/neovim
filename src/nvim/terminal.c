...
static VTermKey convert_key(int key, VTermModifier *statep)
{
  ...
  switch (key) {
    ...
    case K_K7:        return VTERM_KEY_KP_7;
    case K_K8:        return VTERM_KEY_KP_8;
    case K_K9:        return VTERM_KEY_KP_9;
