  ...
  FUNC_ATTR_NONNULL_ALL
{
  ...
  set_option_value("buftype", STATIC_CSTR_AS_OPTVAL("terminal"), OPT_LOCAL, 0, false);  // -V666
  ...
  set_option_value("wrap", BOOLEAN_OPTVAL(false), OPT_LOCAL, 0, false);
  set_option_value("list", BOOLEAN_OPTVAL(false), OPT_LOCAL, 0, false);
