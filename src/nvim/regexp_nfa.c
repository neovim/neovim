...
static int nfa_classcodes[]
    = {NFA_ANY,   NFA_IDENT,  NFA_SIDENT, NFA_KWORD,  NFA_SKWORD, NFA_FNAME,  NFA_SFNAME,
       NFA_PRINT, NFA_SPRINT, NFA_WHITE,  NFA_NWHITE, NFA_DIGIT,  NFA_NDIGIT, NFA_HEX,
       NFA_NHEX,  NFA_OCTAL,  NFA_NOCTAL, NFA_WORD,   NFA_NWORD,  NFA_HEAD,   NFA_NHEAD,
       NFA_ALPHA, NFA_NALPHA, NFA_LOWER,  NFA_NLOWER, NFA_UPPER,  NFA_NUPPER};
...
#define y_diaeresis 0xff
    switch (c) {
      ...
      case A_ring:
        CASEMBC(0x100)
        CASEMBC(0x102) CASEMBC(0x104) CASEMBC(0x1cd) CASEMBC(0x1de) CASEMBC(0x1e0) CASEMBC(0x1ea2)
            EMIT2('A');
        EMIT2(A_grave);
        EMIT2(A_acute);
        EMIT2(A_circumflex);
        ...
        EMIT2(A_ring);
        EMITMBC(0x100)
        EMITMBC(0x102) EMITMBC(0x104) EMITMBC(0x1cd) EMITMBC(0x1de) EMITMBC(0x1e0)
            EMITMBC(0x1ea2) return;

      case 'B':
        CASEMBC(0x1e02) CASEMBC(0x1e06) EMIT2('B');
        EMITMBC(0x1e02) EMITMBC(0x1e06) return;

      case 'C':
      case C_cedilla:
        CASEMBC(0x106) CASEMBC(0x108) CASEMBC(0x10a) CASEMBC(0x10c) EMIT2('C');
        EMIT2(C_cedilla);
        EMITMBC(0x106) EMITMBC(0x108) EMITMBC(0x10a) EMITMBC(0x10c) return;

      case 'D':
        CASEMBC(0x10e) CASEMBC(0x110) CASEMBC(0x1e0a) CASEMBC(0x1e0e) CASEMBC(0x1e10) EMIT2('D');
        EMITMBC(0x10e) EMITMBC(0x110) EMITMBC(0x1e0a) EMITMBC(0x1e0e) EMITMBC(0x1e10) return;
      ...
      case E_diaeresis:
        CASEMBC(0x112)
        CASEMBC(0x114) CASEMBC(0x116) CASEMBC(0x118) CASEMBC(0x11a) CASEMBC(0x1eba) CASEMBC(0x1ebc)
            EMIT2('E');
        EMIT2(E_grave);
        EMIT2(E_acute);
        EMIT2(E_circumflex);
        EMIT2(E_diaeresis);
        EMITMBC(0x112)
        EMITMBC(0x114) EMITMBC(0x116) EMITMBC(0x118) EMITMBC(0x11a) EMITMBC(0x1eba)
            EMITMBC(0x1ebc) return;
      ...
      case 'G':
        CASEMBC(0x11c)
        CASEMBC(0x11e) CASEMBC(0x120) CASEMBC(0x122) CASEMBC(0x1e4) CASEMBC(0x1e6) CASEMBC(0x1f4)
            CASEMBC(0x1e20) EMIT2('G');
        EMITMBC(0x11c)
        EMITMBC(0x11e) EMITMBC(0x120) EMITMBC(0x122) EMITMBC(0x1e4) EMITMBC(0x1e6) EMITMBC(0x1f4)
            EMITMBC(0x1e20) return;

      case 'H':
        CASEMBC(0x124) CASEMBC(0x126) CASEMBC(0x1e22) CASEMBC(0x1e26) CASEMBC(0x1e28) EMIT2('H');
        EMITMBC(0x124) EMITMBC(0x126) EMITMBC(0x1e22) EMITMBC(0x1e26) EMITMBC(0x1e28) return;
      ...
      case I_diaeresis:
        CASEMBC(0x128)
        CASEMBC(0x12a) CASEMBC(0x12c) CASEMBC(0x12e) CASEMBC(0x130) CASEMBC(0x1cf) CASEMBC(0x1ec8)
            EMIT2('I');
        EMIT2(I_grave);
        EMIT2(I_acute);
        EMIT2(I_circumflex);
        EMIT2(I_diaeresis);
        EMITMBC(0x128)
        EMITMBC(0x12a) EMITMBC(0x12c) EMITMBC(0x12e) EMITMBC(0x130) EMITMBC(0x1cf)
            EMITMBC(0x1ec8) return;
      ...
      case 'K':
        CASEMBC(0x136) CASEMBC(0x1e8) CASEMBC(0x1e30) CASEMBC(0x1e34) EMIT2('K');
        EMITMBC(0x136) EMITMBC(0x1e8) EMITMBC(0x1e30) EMITMBC(0x1e34) return;

      case 'L':
        CASEMBC(0x139)
        CASEMBC(0x13b) CASEMBC(0x13d) CASEMBC(0x13f) CASEMBC(0x141) CASEMBC(0x1e3a) EMIT2('L');
        EMITMBC(0x139)
        EMITMBC(0x13b) EMITMBC(0x13d) EMITMBC(0x13f) EMITMBC(0x141) EMITMBC(0x1e3a) return;

      case 'M':
        CASEMBC(0x1e3e) CASEMBC(0x1e40) EMIT2('M');
        EMITMBC(0x1e3e) EMITMBC(0x1e40) return;

      case 'N':
      case N_virguilla:
        CASEMBC(0x143) CASEMBC(0x145) CASEMBC(0x147) CASEMBC(0x1e44) CASEMBC(0x1e48) EMIT2('N');
        EMIT2(N_virguilla);
        EMITMBC(0x143) EMITMBC(0x145) EMITMBC(0x147) EMITMBC(0x1e44) EMITMBC(0x1e48) return;
      ...
      case O_slash:
        CASEMBC(0x14c)
        CASEMBC(0x14e) CASEMBC(0x150) CASEMBC(0x1a0) CASEMBC(0x1d1) CASEMBC(0x1ea) CASEMBC(0x1ec)
        ...
        EMIT2(O_slash);
        EMITMBC(0x14c)
        EMITMBC(0x14e) EMITMBC(0x150) EMITMBC(0x1a0) EMITMBC(0x1d1) EMITMBC(0x1ea) EMITMBC(0x1ec)
            EMITMBC(0x1ece) return;

      case 'P':
      case 0x1e54:
      case 0x1e56:
        EMIT2('P');
        EMITMBC(0x1e54) EMITMBC(0x1e56) return;

      case 'R':
        CASEMBC(0x154) CASEMBC(0x156) CASEMBC(0x158) CASEMBC(0x1e58) CASEMBC(0x1e5e) EMIT2('R');
        EMITMBC(0x154) EMITMBC(0x156) EMITMBC(0x158) EMITMBC(0x1e58) EMITMBC(0x1e5e) return;

      case 'S':
        CASEMBC(0x15a) CASEMBC(0x15c) CASEMBC(0x15e) CASEMBC(0x160) CASEMBC(0x1e60) EMIT2('S');
        EMITMBC(0x15a) EMITMBC(0x15c) EMITMBC(0x15e) EMITMBC(0x160) EMITMBC(0x1e60) return;

      case 'T':
        CASEMBC(0x162) CASEMBC(0x164) CASEMBC(0x166) CASEMBC(0x1e6a) CASEMBC(0x1e6e) EMIT2('T');
        EMITMBC(0x162) EMITMBC(0x164) EMITMBC(0x166) EMITMBC(0x1e6a) EMITMBC(0x1e6e) return;
      ...
      case U_circumflex:
        CASEMBC(0x168)
        CASEMBC(0x16a) CASEMBC(0x16c) CASEMBC(0x16e) CASEMBC(0x170) CASEMBC(0x172) CASEMBC(0x1af)
        ...
        EMIT2(U_circumflex);
        EMITMBC(0x168)
        EMITMBC(0x16a) EMITMBC(0x16c) EMITMBC(0x16e) EMITMBC(0x170) EMITMBC(0x172) EMITMBC(0x1af)
            EMITMBC(0x1d3) EMITMBC(0x1ee6) return;
      ...
      case 'W':
        CASEMBC(0x174) CASEMBC(0x1e80) CASEMBC(0x1e82) CASEMBC(0x1e84) CASEMBC(0x1e86) EMIT2('W');
        EMITMBC(0x174) EMITMBC(0x1e80) EMITMBC(0x1e82) EMITMBC(0x1e84) EMITMBC(0x1e86) return;

      case 'X':
        CASEMBC(0x1e8a) CASEMBC(0x1e8c) EMIT2('X');
        EMITMBC(0x1e8a) EMITMBC(0x1e8c) return;

      case 'Y':
      case Y_acute:
        CASEMBC(0x176)
        CASEMBC(0x178) CASEMBC(0x1e8e) CASEMBC(0x1ef2) CASEMBC(0x1ef6) CASEMBC(0x1ef8) EMIT2('Y');
        EMIT2(Y_acute);
        EMITMBC(0x176)
        EMITMBC(0x178) EMITMBC(0x1e8e) EMITMBC(0x1ef2) EMITMBC(0x1ef6) EMITMBC(0x1ef8) return;

      case 'Z':
        CASEMBC(0x179)
        CASEMBC(0x17b) CASEMBC(0x17d) CASEMBC(0x1b5) CASEMBC(0x1e90) CASEMBC(0x1e94) EMIT2('Z');
        EMITMBC(0x179)
        EMITMBC(0x17b) EMITMBC(0x17d) EMITMBC(0x1b5) EMITMBC(0x1e90) EMITMBC(0x1e94) return;
      ...
      case a_ring:
        CASEMBC(0x101)
        CASEMBC(0x103) CASEMBC(0x105) CASEMBC(0x1ce) CASEMBC(0x1df) CASEMBC(0x1e1) CASEMBC(0x1ea3)
            EMIT2('a');
        EMIT2(a_grave);
        EMIT2(a_acute);
        EMIT2(a_circumflex);
        ...
        EMIT2(a_ring);
        EMITMBC(0x101)
        EMITMBC(0x103) EMITMBC(0x105) EMITMBC(0x1ce) EMITMBC(0x1df) EMITMBC(0x1e1)
            EMITMBC(0x1ea3) return;

      case 'b':
        CASEMBC(0x1e03) CASEMBC(0x1e07) EMIT2('b');
        EMITMBC(0x1e03) EMITMBC(0x1e07) return;

      case 'c':
      case c_cedilla:
        CASEMBC(0x107) CASEMBC(0x109) CASEMBC(0x10b) CASEMBC(0x10d) EMIT2('c');
        EMIT2(c_cedilla);
        EMITMBC(0x107) EMITMBC(0x109) EMITMBC(0x10b) EMITMBC(0x10d) return;

      case 'd':
        CASEMBC(0x10f) CASEMBC(0x111) CASEMBC(0x1e0b) CASEMBC(0x1e0f) CASEMBC(0x1e11) EMIT2('d');
        EMITMBC(0x10f) EMITMBC(0x111) EMITMBC(0x1e0b) EMITMBC(0x1e0f) EMITMBC(0x1e11) return;
      ...
      case e_diaeresis:
        CASEMBC(0x113)
        CASEMBC(0x115) CASEMBC(0x117) CASEMBC(0x119) CASEMBC(0x11b) CASEMBC(0x1ebb) CASEMBC(0x1ebd)
            EMIT2('e');
        EMIT2(e_grave);
        EMIT2(e_acute);
        EMIT2(e_circumflex);
        EMIT2(e_diaeresis);
        EMITMBC(0x113)
        EMITMBC(0x115) EMITMBC(0x117) EMITMBC(0x119) EMITMBC(0x11b) EMITMBC(0x1ebb)
            EMITMBC(0x1ebd) return;
      ...
      case 'g':
        CASEMBC(0x11d)
        CASEMBC(0x11f) CASEMBC(0x121) CASEMBC(0x123) CASEMBC(0x1e5) CASEMBC(0x1e7) CASEMBC(0x1f5)
            CASEMBC(0x1e21) EMIT2('g');
        EMITMBC(0x11d)
        EMITMBC(0x11f) EMITMBC(0x121) EMITMBC(0x123) EMITMBC(0x1e5) EMITMBC(0x1e7) EMITMBC(0x1f5)
            EMITMBC(0x1e21) return;

      case 'h':
        CASEMBC(0x125)
        CASEMBC(0x127) CASEMBC(0x1e23) CASEMBC(0x1e27) CASEMBC(0x1e29) CASEMBC(0x1e96) EMIT2('h');
        EMITMBC(0x125)
        EMITMBC(0x127) EMITMBC(0x1e23) EMITMBC(0x1e27) EMITMBC(0x1e29) EMITMBC(0x1e96) return;
      ...
      case i_diaeresis:
        CASEMBC(0x129)
        CASEMBC(0x12b) CASEMBC(0x12d) CASEMBC(0x12f) CASEMBC(0x1d0) CASEMBC(0x1ec9) EMIT2('i');
        EMIT2(i_grave);
        EMIT2(i_acute);
        EMIT2(i_circumflex);
        EMIT2(i_diaeresis);
        EMITMBC(0x129)
        EMITMBC(0x12b) EMITMBC(0x12d) EMITMBC(0x12f) EMITMBC(0x1d0) EMITMBC(0x1ec9) return;

      case 'j':
        CASEMBC(0x135) CASEMBC(0x1f0) EMIT2('j');
        EMITMBC(0x135) EMITMBC(0x1f0) return;

      case 'k':
        CASEMBC(0x137) CASEMBC(0x1e9) CASEMBC(0x1e31) CASEMBC(0x1e35) EMIT2('k');
        EMITMBC(0x137) EMITMBC(0x1e9) EMITMBC(0x1e31) EMITMBC(0x1e35) return;

      case 'l':
        CASEMBC(0x13a)
        CASEMBC(0x13c) CASEMBC(0x13e) CASEMBC(0x140) CASEMBC(0x142) CASEMBC(0x1e3b) EMIT2('l');
        EMITMBC(0x13a)
        EMITMBC(0x13c) EMITMBC(0x13e) EMITMBC(0x140) EMITMBC(0x142) EMITMBC(0x1e3b) return;

      case 'm':
        CASEMBC(0x1e3f) CASEMBC(0x1e41) EMIT2('m');
        EMITMBC(0x1e3f) EMITMBC(0x1e41) return;

      case 'n':
      case n_virguilla:
        CASEMBC(0x144)
        CASEMBC(0x146) CASEMBC(0x148) CASEMBC(0x149) CASEMBC(0x1e45) CASEMBC(0x1e49) EMIT2('n');
        EMIT2(n_virguilla);
        EMITMBC(0x144)
        EMITMBC(0x146) EMITMBC(0x148) EMITMBC(0x149) EMITMBC(0x1e45) EMITMBC(0x1e49) return;
      ...
      case o_slash:
        CASEMBC(0x14d)
        CASEMBC(0x14f) CASEMBC(0x151) CASEMBC(0x1a1) CASEMBC(0x1d2) CASEMBC(0x1eb) CASEMBC(0x1ed)
        ...
        EMIT2(o_slash);
        EMITMBC(0x14d)
        EMITMBC(0x14f) EMITMBC(0x151) EMITMBC(0x1a1) EMITMBC(0x1d2) EMITMBC(0x1eb) EMITMBC(0x1ed)
            EMITMBC(0x1ecf) return;

      case 'p':
        CASEMBC(0x1e55) CASEMBC(0x1e57) EMIT2('p');
        EMITMBC(0x1e55) EMITMBC(0x1e57) return;

      case 'r':
        CASEMBC(0x155) CASEMBC(0x157) CASEMBC(0x159) CASEMBC(0x1e59) CASEMBC(0x1e5f) EMIT2('r');
        EMITMBC(0x155) EMITMBC(0x157) EMITMBC(0x159) EMITMBC(0x1e59) EMITMBC(0x1e5f) return;

      case 's':
        CASEMBC(0x15b) CASEMBC(0x15d) CASEMBC(0x15f) CASEMBC(0x161) CASEMBC(0x1e61) EMIT2('s');
        EMITMBC(0x15b) EMITMBC(0x15d) EMITMBC(0x15f) EMITMBC(0x161) EMITMBC(0x1e61) return;

      case 't':
        CASEMBC(0x163)
        CASEMBC(0x165) CASEMBC(0x167) CASEMBC(0x1e6b) CASEMBC(0x1e6f) CASEMBC(0x1e97) EMIT2('t');
        EMITMBC(0x163)
        EMITMBC(0x165) EMITMBC(0x167) EMITMBC(0x1e6b) EMITMBC(0x1e6f) EMITMBC(0x1e97) return;
      ...
      case u_diaeresis:
        CASEMBC(0x169)
        CASEMBC(0x16b) CASEMBC(0x16d) CASEMBC(0x16f) CASEMBC(0x171) CASEMBC(0x173) CASEMBC(0x1b0)
        ...
        EMIT2(u_diaeresis);
        EMITMBC(0x169)
        EMITMBC(0x16b) EMITMBC(0x16d) EMITMBC(0x16f) EMITMBC(0x171) EMITMBC(0x173) EMITMBC(0x1b0)
            EMITMBC(0x1d4) EMITMBC(0x1ee7) return;
      ...
      case 'w':
        CASEMBC(0x175)
        CASEMBC(0x1e81) CASEMBC(0x1e83) CASEMBC(0x1e85) CASEMBC(0x1e87) CASEMBC(0x1e98) EMIT2('w');
        EMITMBC(0x175)
        EMITMBC(0x1e81) EMITMBC(0x1e83) EMITMBC(0x1e85) EMITMBC(0x1e87) EMITMBC(0x1e98) return;

      case 'x':
        CASEMBC(0x1e8b) CASEMBC(0x1e8d) EMIT2('x');
        EMITMBC(0x1e8b) EMITMBC(0x1e8d) return;

      case 'y':
      case y_acute:
      case y_diaeresis:
        CASEMBC(0x177)
        CASEMBC(0x1e8f) CASEMBC(0x1e99) CASEMBC(0x1ef3) CASEMBC(0x1ef7) CASEMBC(0x1ef9) EMIT2('y');
        EMIT2(y_acute);
        EMIT2(y_diaeresis);
        EMITMBC(0x177)
        EMITMBC(0x1e8f) EMITMBC(0x1e99) EMITMBC(0x1ef3) EMITMBC(0x1ef7) EMITMBC(0x1ef9) return;

      case 'z':
        CASEMBC(0x17a)
        CASEMBC(0x17c) CASEMBC(0x17e) CASEMBC(0x1b6) CASEMBC(0x1e91) CASEMBC(0x1e95) EMIT2('z');
        EMITMBC(0x17a)
        EMITMBC(0x17c) EMITMBC(0x17e) EMITMBC(0x1b6) EMITMBC(0x1e91) EMITMBC(0x1e95) return;
    ...
    case Magic('z'):
      ...
      switch (c) {
        ...
        case '(':
          ...
          break;
        default:
          semsg(_("E867: (NFA) Unknown operator '\\z%c'"), no_Magic(c));
          return FAIL;
      }
      break;
    ...
    case Magic('%'):
      ...
      switch (c) {
        ...
        default: {
          ...
          semsg(_("E867: (NFA) Unknown operator '\\%%%c'"), no_Magic(c));
          return FAIL;
      }
      break;
    ...
    collection:
      ...
      if (*endp == ']') {
        ...
        while (regparse < endp) {
          ...
          if (*regparse == '\\' && regparse + 1 <= endp
              && (vim_strchr(REGEXP_INRANGE, regparse[1]) != NULL
                  || (!reg_cpo_lit && vim_strchr(REGEXP_ABBR, regparse[1]) != NULL))) {
            MB_PTR_ADV(regparse);

            if (*regparse == 'n') {
              startc = (reg_string || emit_range || regparse[1] == '-') ? NL : NFA_NEWL;
            } else if (*regparse == 'd' || *regparse == 'o' || *regparse == 'x' || *regparse == 'u'
                       || *regparse == 'U') {
  ...
  switch (op) {
    ...
    case Magic('{'):
      ...
      if ((nfa_re_flags & RE_AUTO) && (maxval > 500 || maxval > minval + 200)
          && (maxval != MAX_LIMIT && minval < 200) && !wants_nfa) {
        return FAIL;
      }
...
static void nfa_set_code(int c)
{
  ...
  switch (c) {
    ...
    case NFA_CLASS_IDENT:
      STRCPY(code, "NFA_CLASS_IDENT");
      break;
    case NFA_CLASS_KEYWORD:
      STRCPY(code, "NFA_CLASS_KEYWORD");
      break;
    case NFA_CLASS_FNAME:
      STRCPY(code, "NFA_CLASS_FNAME");
      break;
...
static void nfa_print_state2(FILE *debugf, nfa_state_T *state, garray_T *indent)
{
  ...
  fprintf(debugf, "%s (%d) (id=%d) val=%d\n", code, state->c, abs(state->id), state->val);
  if (state->id < 0)
    return;
...
#define POP()                                                                                      \
  ...
  if (stackp != stack) {
    xfree(stack);
    EMSG_RET_NULL(
        _("E875: (NFA regexp) (While converting from postfix to NFA),"
...
static void nfa_postprocess(nfa_regprog_T *prog)
{
  ...
  for (i = 0; i < prog->nstate; ++i) {
    c = prog->state[i].c;
    if (c == NFA_START_INVISIBLE || c == NFA_START_INVISIBLE_NEG || c == NFA_START_INVISIBLE_BEFORE
  ...
  for (j = 0; j < sub->in_use; j++)
    if (REG_MULTI)
      fprintf(log_fd, "*** group %d, start: c=%d, l=%d, end: c=%d, l=%d\n", j,
              sub->list.multi[j].start_col, (int)sub->list.multi[j].start_lnum,
              sub->list.multi[j].end_col, (int)sub->list.multi[j].end_lnum);
    else {
...
static char *pim_info(const nfa_pim_T *pim)
{
  ...
  if (pim == NULL || pim->result == NFA_PIM_UNUSED) {
    ...
    snprintf(buf, sizeof(buf), " PIM col %d",
             REG_MULTI ? (int)pim->end.pos.col : (int)(pim->end.ptr - rex.input));
  }
  return buf;
}
...
static void clear_sub(regsub_T *sub)
{
  if (REG_MULTI) {
    ...
    memset(sub->list.multi, 0xff, sizeof(struct multipos) * rex.nfa_nsubexpr);
  } else {
...
static void copy_sub(regsub_T *to, regsub_T *from)
{
  ...
  if (from->in_use > 0) {
    ...
    if (REG_MULTI)
      memmove(&to->list.multi[0], &from->list.multi[0], sizeof(struct multipos) * from->in_use);
    else
...
static void copy_sub_off(regsub_T *to, regsub_T *from)
{
  ...
  if (from->in_use > 1) {
    ...
    if (REG_MULTI)
      ...
      memmove(&to->list.line[1], &from->list.line[1], sizeof(struct linepos) * (from->in_use - 1));
  }
}
...
static void report_state(char *action, regsub_T *sub, nfa_state_T *state, int lid, nfa_pim_T *pim)
{
  ...
  fprintf(log_fd, "> %s state %d to list %d. char %d: %s (start col %d)%s\n", action,
          abs(state->id), lid, state->c, code, col, pim_info(pim));
}
                               ...
                               ) FUNC_ATTR_NONNULL_ARG(1, 2, 3)
{
  for (int i = 0; i < l->n; i++) {
    ...
    if (thread->state->id == state->id && sub_equal(&thread->subs.norm, &subs->norm)
        && (!rex.nfa_has_zsubexpr || sub_equal(&thread->subs.synt, &subs->synt))
    ...
    FUNC_ATTR_NONNULL_ARG(1, 2) FUNC_ATTR_WARN_UNUSED_RESULT
{
  ...
  switch (state->c) {
    ...
    case NFA_BOF:
      ...
      if (rex.input > rex.line && *rex.input != NUL
          && (nfa_endp == NULL || !REG_MULTI || rex.lnum == nfa_endp->se_u.pos.lnum)) {
        goto skip_add;
      }
      FALLTHROUGH;
    ...
    default:
      if (state->lastlist[nfa_ll_index] == l->id && state->c != NFA_SKIP) {
        ...
        if (!rex.nfa_has_backref && pim == NULL && !l->has_pim && state->c != NFA_MATCH) {
          ...
          skip_add:
            ...
            fprintf(log_fd,
                    ...
                    abs(state->id), l->id, state->c, code, pim == NULL ? "NULL" : "yes", l->has_pim,
                    found);
#endif
            depth--;
            return subs;
  ...
  switch (state->c) {
    ...
    case NFA_ZSTART:
      ...
      if (REG_MULTI) {
        ...
        if (off == -1) {
          ...
          sub->list.multi[subidx].start_col = (colnr_T)(rex.input - rex.line + off);
        }
    ...
    case NFA_MCLOSE:
      if (rex.nfa_has_zend
          && (REG_MULTI ? subs->norm.list.multi[0].end_lnum >= 0
    ...
    case NFA_ZEND:
      ...
      if (REG_MULTI) {
        ...
        if (off == -1) {
          ...
          sub->list.multi[subidx].end_col = (colnr_T)(rex.input - rex.line + off);
        }
        /* avoid compiler warnings */
        save_ptr = NULL;
      } else {
...
static regsubs_T *addstate_here(nfa_list_T *l,       // runtime state list
                                ...
                                regsubs_T *subs,     // pointers to subexpressions
                                nfa_pim_T *pim,      // postponed look-behind match
                                int *ip) FUNC_ATTR_NONNULL_ARG(1, 2, 5) FUNC_ATTR_WARN_UNUSED_RESULT
{
  int tlen = l->n;
  int count;
  int listidx = *ip;
  ...
  if (count == 1) {
    ...
    if (l->n + count - 1 >= l->len) {
      ...
      l->len = newlen;
      memmove(&(newl[0]), &(l->t[0]), sizeof(nfa_thread_T) * listidx);
      memmove(&(newl[listidx]), &(l->t[l->n - count]), sizeof(nfa_thread_T) * count);
      memmove(&(newl[listidx + count]), &(l->t[listidx + 1]),
      ...
      memmove(&(l->t[listidx + count]), &(l->t[listidx + 1]),
              sizeof(nfa_thread_T) * (l->n - listidx - 1));
      memmove(&(l->t[listidx]), &(l->t[l->n - 1]), sizeof(nfa_thread_T) * count);
    }
  }
  --l->n;
  *ip = listidx - 1;
...
)
{
  ...
  if (REG_MULTI) {
    ...
    if (sub->list.multi[subidx].start_lnum == rex.lnum
      ...
      if (cstrncmp(rex.line + sub->list.multi[subidx].start_col, rex.input, &len) == 0) {
        *bytelen = len;
        return true;
      }
    } else {
      if (match_with_backref(sub->list.multi[subidx].start_lnum, sub->list.multi[subidx].start_col,
                             sub->list.multi[subidx].end_lnum, sub->list.multi[subidx].end_col,
                             bytelen)
          == RA_MATCH) {
        return true;
      }
 ...
 * position).
 */
static int recursive_regmatch(nfa_state_T *state,
                              nfa_pim_T *pim,
                              nfa_regprog_T *prog,
                              regsubs_T *submatch,
                              regsubs_T *m,
                              int **listids,
                              int *listids_len) FUNC_ATTR_NONNULL_ARG(1, 3, 5, 6, 7)
{
  ...
  if (state->c == NFA_START_INVISIBLE_BEFORE || state->c == NFA_START_INVISIBLE_BEFORE_FIRST
...
#define PTR2LEN(x) utf_ptr2len(x)
  ...
  for (;;) {
    ...
    while (*s1) {
      ...
      if ((c1 != c2 && (!rex.reg_ic || utf_fold(c1) != utf_fold(c2))) || c1_len != c2_len) {
        match = false;
        break;
      }
      s1 += c1_len;
...
#define ADD_STATE_IF_MATCH(state)                                                                  \
  ...
  for (;;) {
    ...
    for (listidx = 0; listidx < thislist->n; listidx++) {
...
#ifdef REGEXP_DEBUG
      {
        ...
        fprintf(log_fd, "(%d) char %d %s (start col %d)%s... \n", abs(t->state->id),
                (int)t->state->c, code, col, pim_info(&t->pim));
      }
#endif
      ...
      switch (t->state->c) {
        case NFA_MATCH: {
          ...
          if (!rex.reg_icombine && rex.input != rex.line && utf_iscomposing(curc)) {
            break;
          }
          nfa_match = true;
        ...
        case NFA_END_PATTERN:
          ...
          if (nfa_endp != NULL) {
            if (REG_MULTI) {
              fprintf(log_fd,
                      ...
                      (int)rex.lnum, (int)nfa_endp->se_u.pos.lnum, (int)(rex.input - rex.line),
          ...
          // "nfa_endp"
          if (nfa_endp != NULL
              && (REG_MULTI ? (rex.lnum != nfa_endp->se_u.pos.lnum
        ...
        case NFA_START_INVISIBLE_BEFORE_NEG_FIRST: {
          ...
          fprintf(log_fd, "Failure chance invisible: %d, what follows: %d\n",
                  failure_chance(t->state->out, 0), failure_chance(t->state->out1->out, 0));
#endif
          // Do it directly if there already is a PIM or when
          // nfa_postprocess() detected it will work better.
          if (t->pim.result != NFA_PIM_UNUSED || t->state->c == NFA_START_INVISIBLE_FIRST
            ...
            // follows.
            result = recursive_regmatch(t->state, NULL, prog, submatch, m, &listids, &listids_len);
            if (result == NFA_TOO_EXPENSIVE) {
              nfa_match = result;
              goto theend;
            }
            ...
            // false
            if (result
                != (t->state->c == NFA_START_INVISIBLE_NEG
                    || t->state->c == NFA_START_INVISIBLE_NEG_FIRST
        ...
        case NFA_START_PATTERN: {
          ...
          if (skip != NULL) {
            ...
            nfa_set_code(skip->c);
            fprintf(log_fd,
                    "> Not trying to match pattern, output state %d is already in list %d. char "
                    "%d: %s\n",
          ...
          if (result) {
            ...
            if (REG_MULTI) {
              ...
              bytelen = m->norm.list.multi[0].end_col - (int)(rex.input - rex.line);
            } else {
        ...
        case NFA_BOF:
          if (rex.lnum == 0 && rex.input == rex.line && (!REG_MULTI || rex.reg_firstlnum == 1)) {
            add_here = true;
            add_state = t->state->out;
          }
          break;
        ...
        case NFA_NEWL:
          if (curc == NUL && !rex.reg_line_lbr && REG_MULTI && rex.lnum <= rex.reg_maxline) {
            go_to_nextline = true;
              ...
              if (rex.reg_ic) {
                ...
                if (done) {
                  break;
                                    ...
                                    : (curc == state->c
                                       || (rex.reg_ic && utf_fold(curc) == utf_fold(state->c)))) {
              result = result_if_matched;
              break;
            }
            state = state->out;
        ...
        case NFA_SKWORD:  //  \K
          result = !ascii_isdigit(curc) && vim_iswordp_buf(rex.input, rex.reg_buf);
          ADD_STATE_IF_MATCH(t->state);
          break;
        ...
        case NFA_LNUM_LT:
          assert(t->state->val >= 0
                 && !((rex.reg_firstlnum > 0 && rex.lnum > LONG_MAX - rex.reg_firstlnum)
                      || (rex.reg_firstlnum < 0 && rex.lnum < LONG_MIN + rex.reg_firstlnum))
                 && rex.lnum + rex.reg_firstlnum >= 0);
          result = (REG_MULTI
                    && nfa_re_num_cmp((uintmax_t)t->state->val, t->state->c - NFA_LNUM,
        ...
        case NFA_COL_GT:
        case NFA_COL_LT:
          assert(t->state->val >= 0 && rex.input >= rex.line
                 && (uintmax_t)(rex.input - rex.line) <= UINTMAX_MAX - 1);
          result = nfa_re_num_cmp((uintmax_t)t->state->val, t->state->c - NFA_COL,
        ...
        case NFA_MARK_LT: {
          ...
          if (pos != NULL && pos->lnum > 0) {
            const colnr_T pos_col
                = pos->lnum == rex.lnum + rex.reg_firstlnum && pos->col == MAXCOL
            ...
            result = pos->lnum == rex.lnum + rex.reg_firstlnum
                         ...
                         : (pos->lnum < rex.lnum + rex.reg_firstlnum ? t->state->c == NFA_MARK_GT
                                                                     : t->state->c == NFA_MARK_LT);
            if (result) {
              add_here = true;
              add_state = t->state->out;
      ...
      if (add_state != NULL) {
        ...
        if (pim != NULL && (clen == 0 || match_follows(add_state, 0))) {
          if (pim->result == NFA_PIM_TODO) {
            ...
            fprintf(log_fd, "\n");
#endif
            result = recursive_regmatch(pim->state, pim, prog, submatch, m, &listids, &listids_len);
            pim->result = result ? NFA_PIM_MATCH : NFA_PIM_NOMATCH;
            // for \@! and \@<! it is a match when the result is
            // false
            if (result
                != (pim->state->c == NFA_START_INVISIBLE_NEG
    ...
    if (!nfa_match
        && ((toplevel && rex.lnum == 0 && clen != 0
             && (rex.reg_maxcol == 0 || (colnr_T)(rex.input - rex.line) < rex.reg_maxcol))
            || (nfa_endp != NULL
                && (REG_MULTI ? (rex.lnum < nfa_endp->se_u.pos.lnum
      ...
      if (toplevel) {
        ...
        if (prog->regstart != NUL && clen != 0) {
          if (nextlist->n == 0) {
            ...
            if (c != prog->regstart && (!rex.reg_ic || utf_fold(c) != utf_fold(prog->regstart))) {
#ifdef REGEXP_DEBUG
        ...
        if (add) {
          if (REG_MULTI) {
            m->norm.list.multi[0].start_col = (colnr_T)(rex.input - rex.line) + clen;
          } else {
  ...
  if (prog->reghasz == REX_SET) {
    ...
    for (i = 1; i < subs.synt.in_use; i++) {
      if (REG_MULTI) {
        ...
        if (mpos->start_lnum >= 0 && mpos->start_lnum == mpos->end_lnum
            && mpos->end_col >= mpos->start_col) {
          re_extmatch_out->matches[i] = vim_strnsave(
        ...
        if (lpos->start != NULL && lpos->end != NULL)
          re_extmatch_out->matches[i] = vim_strnsave(lpos->start, lpos->end - lpos->start);
      }
    }
  }
