...
static const NeoTerminfo NEW__ansi_terminfo = {
  .bce = false,
  .has_Tc_or_RGB = false,
  .Su = false,
  .max_colors = 8,
...
static const NeoTerminfo NEW__interix_8colour_terminfo = {
  .bce = true,
  .has_Tc_or_RGB = false,
  .Su = false,
  .max_colors = 8,
...
static const NeoTerminfo NEW__iterm_256colour_terminfo = {
  .bce = true,
  .has_Tc_or_RGB = false,
  .Su = false,
  .max_colors = 0x100,
  ...
  .defs = {
    ...
    [kTerm_enter_underline_mode] = "\033[4m",
    [kTerm_erase_chars] = NULL,
    [kTerm_exit_attribute_mode] = "\033[m^O",
    [kTerm_exit_ca_mode] = "\033[?1049l\033[23;0;0t",
    [kTerm_flash_screen] = "\033[?5h$<200/>\033[?5l",
    ...
    [kTerm_set_attributes] = "\033[0%?%p6%t;1%;%?%p2%t;4%;%?%p1%p3%|%t;7%;%?%p4%t;5%;%?%p5%t;2%;m%?%p9%t^N%e^O%;",
    [kTerm_set_lr_margin] = NULL,
...
static const NeoTerminfo NEW__linux_16colour_terminfo = {
  .bce = true,
  .has_Tc_or_RGB = false,
  .Su = false,
  .max_colors = 8,
  ...
  .defs = {
    ...
    [kTerm_set_a_background] = "\033[4%p1%dm",
    [kTerm_set_a_foreground] = "\033[3%p1%dm",
    [kTerm_set_attributes] = "\033[0;10%?%p1%t;7%;%?%p2%t;4%;%?%p3%t;7%;%?%p4%t;5%;%?%p5%t;2%;%?%p6%t;1%;m%?%p9%t^N%e^O%;",
    [kTerm_set_lr_margin] = NULL,
    [kTerm_to_status_line] = NULL,
    [kTerm_reset_cursor_style] = NULL,
    [kTerm_set_cursor_style] = NULL,
...
static const NeoTerminfo NEW__putty_256colour_terminfo = {
  .bce = true,
  .has_Tc_or_RGB = false,
  .Su = false,
  .max_colors = 0x100,
  ...
  .defs = {
    ...
    [kTerm_erase_chars] = "\033[%p1%dX",
    [kTerm_exit_attribute_mode] = "\033[m^O",
    [kTerm_exit_ca_mode] = "\033[2J\033[?47l",
    [kTerm_flash_screen] = "\033[?5h$<100/>\033[?5l",
    [kTerm_from_status_line] = "\a",
    [kTerm_insert_line] = "\033[L",
    [kTerm_keypad_local] = "\033[?1l\033>",
    [kTerm_keypad_xmit] = "\033[?1h\033=",
    ...
    [kTerm_set_a_background] = "\033[%?%p1%{8}%<%t4%p1%d%e%p1%{16}%<%t10%p1%{8}%-%d%e48;5;%p1%d%;m",
    [kTerm_set_a_foreground] = "\033[%?%p1%{8}%<%t3%p1%d%e%p1%{16}%<%t9%p1%{8}%-%d%e38;5;%p1%d%;m",
    [kTerm_set_attributes] = "\033[0%?%p1%p6%|%t;1%;%?%p2%t;4%;%?%p1%p3%|%t;7%;%?%p4%t;5%;m%?%p9%t^N%e^O%;",
    [kTerm_set_lr_margin] = NULL,
...
static const NeoTerminfo NEW__rxvt_256colour_terminfo = {
  .bce = true,
  .has_Tc_or_RGB = false,
  .Su = false,
  .max_colors = 0x100,
  ...
  .defs = {
    ...
    [kTerm_set_a_background] = "\033[%?%p1%{8}%<%t4%p1%d%e%p1%{16}%<%t10%p1%{8}%-%d%e48;5;%p1%d%;m",
    [kTerm_set_a_foreground] = "\033[%?%p1%{8}%<%t3%p1%d%e%p1%{16}%<%t9%p1%{8}%-%d%e38;5;%p1%d%;m",
    [kTerm_set_attributes] = "\033[0%?%p6%t;1%;%?%p2%t;4%;%?%p1%p3%|%t;7%;%?%p4%t;5%;m%?%p9%t^N%e^O%;",
    [kTerm_set_lr_margin] = NULL,
    [kTerm_to_status_line] = NULL,
    [kTerm_reset_cursor_style] = NULL,
    [kTerm_set_cursor_style] = NULL,
...
static const NeoTerminfo NEW__screen_256colour_terminfo = {
  .bce = false,
  .has_Tc_or_RGB = false,
  .Su = false,
  .max_colors = 0x100,
  ...
  .defs = {
    ...
    [kTerm_set_a_background] = "\033[%?%p1%{8}%<%t4%p1%d%e%p1%{16}%<%t10%p1%{8}%-%d%e48;5;%p1%d%;m",
    [kTerm_set_a_foreground] = "\033[%?%p1%{8}%<%t3%p1%d%e%p1%{16}%<%t9%p1%{8}%-%d%e38;5;%p1%d%;m",
    [kTerm_set_attributes] = "\033[0%?%p6%t;1%;%?%p1%t;3%;%?%p2%t;4%;%?%p3%t;7%;%?%p4%t;5%;%?%p5%t;2%;m%?%p9%t^N%e^O%;",
    [kTerm_set_lr_margin] = NULL,
    [kTerm_to_status_line] = NULL,
    [kTerm_reset_cursor_style] = NULL,
    [kTerm_set_cursor_style] = NULL,
...
static const NeoTerminfo NEW__st_256colour_terminfo = {
  .bce = true,
  .has_Tc_or_RGB = false,
  .Su = false,
  .max_colors = 0x100,
...
static const NeoTerminfo NEW__tmux_256colour_terminfo = {
  .bce = false,
  .has_Tc_or_RGB = false,
  .Su = false,
  .max_colors = 0x100,
  ...
  .defs = {
    ...
    [kTerm_set_a_background] = "\033[%?%p1%{8}%<%t4%p1%d%e%p1%{16}%<%t10%p1%{8}%-%d%e48;5;%p1%d%;m",
    [kTerm_set_a_foreground] = "\033[%?%p1%{8}%<%t3%p1%d%e%p1%{16}%<%t9%p1%{8}%-%d%e38;5;%p1%d%;m",
    [kTerm_set_attributes] = "\033[0%?%p6%t;1%;%?%p2%t;4%;%?%p1%p3%|%t;7%;%?%p4%t;5%;%?%p5%t;2%;%?%p7%t;8%;m%?%p9%t^N%e^O%;",
    [kTerm_set_lr_margin] = NULL,
    [kTerm_to_status_line] = "\033]0;",
    [kTerm_reset_cursor_style] = NULL,
    [kTerm_set_cursor_style] = "\033[%p1%d q",
...
static const NeoTerminfo NEW__vte_256colour_terminfo = {
  .bce = true,
  .has_Tc_or_RGB = false,
  .Su = false,
  .max_colors = 0x100,
  ...
  .defs = {
    ...
    [kTerm_enter_underline_mode] = "\033[4m",
    [kTerm_erase_chars] = "\033[%p1%dX",
    [kTerm_exit_attribute_mode] = "\033[0m^O",
    [kTerm_exit_ca_mode] = "\033[2J\033[?47l\0338",
    [kTerm_flash_screen] = "\033[?5h$<100/>\033[?5l",
    [kTerm_from_status_line] = NULL,
    [kTerm_insert_line] = "\033[L",
    ...
    [kTerm_set_a_background] = "\033[%?%p1%{8}%<%t4%p1%d%e%p1%{16}%<%t10%p1%{8}%-%d%e48;5;%p1%d%;m",
    [kTerm_set_a_foreground] = "\033[%?%p1%{8}%<%t3%p1%d%e%p1%{16}%<%t9%p1%{8}%-%d%e38;5;%p1%d%;m",
    [kTerm_set_attributes] = "\033[0%?%p6%t;1%;%?%p2%t;4%;%?%p5%t;2%;%?%p7%t;8%;%?%p1%p3%|%t;7%;m%?%p9%t^N%e^O%;",
    [kTerm_set_lr_margin] = NULL,
    [kTerm_to_status_line] = NULL,
    [kTerm_reset_cursor_style] = NULL,
    [kTerm_set_cursor_style] = NULL,
...
static const NeoTerminfo NEW__xterm_256colour_terminfo = {
  .bce = true,
  .has_Tc_or_RGB = false,
  .Su = false,
  .max_colors = 0x100,
...
static const NeoTerminfo NEW__cygwin_terminfo = {
  .bce = false,
  .has_Tc_or_RGB = false,
  .Su = false,
  .max_colors = 8,
...
static const NeoTerminfo NEW__win32con_terminfo = {
  .bce = false,
  .has_Tc_or_RGB = false,
  .Su = false,
  .max_colors = 8,
...
static const NeoTerminfo NEW__conemu_terminfo = {
  .bce = true,
  .has_Tc_or_RGB = false,
  .Su = false,
  .max_colors = 0x100,
...
static const NeoTerminfo NEW__vtpcon_terminfo = {
  .bce = true,
  .has_Tc_or_RGB = false,
  .Su = false,
  .max_colors = 0x100,
