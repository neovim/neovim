  ...
  ((rb)->first == NULL                                                         \
       ...
       : ((rb)->next == (rb)->first)                                           \
             ...
             : ((rb)->next > (rb)->first)                                      \
                   ...
                   : (size_t)((rb)->next - (rb)->buf + (rb)->buf_end           \
                              - (rb)->first + 1))
...
#define RINGBUF_INIT(TypeName, funcprefix, RBType, rbfree)                     \
  ...
  {                                                                            \
    XFREE_CLEAR(rb->buf);                                                      \
                                                                               ...
                                                                               \
  static inline void funcprefix##_rb_push(                                     \
      TypeName##RingBuffer *const rb, RBType item) REAL_FATTR_NONNULL_ARG(1);  \
