...
#define MSGPACK_SBUFFER_INIT                                                                       \
  (msgpack_sbuffer)                                                                                \
  {                                                                                                \
    .size = 0, .data = NULL, .alloc = 0,                                                           \
  }

#define CONTEXT_INIT                                                                               \
  (Context)                                                                                        \
  {                                                                                                \
    .regs = MSGPACK_SBUFFER_INIT, .jumps = MSGPACK_SBUFFER_INIT, .bufs = MSGPACK_SBUFFER_INIT,     \
    .gvars = MSGPACK_SBUFFER_INIT, .funcs = ARRAY_DICT_INIT,                                       \
  }
