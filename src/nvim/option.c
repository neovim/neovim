  ...
  options[] =
{
  ...
  {"antialias",   "anti", P_BOOL|P_VIM|P_RCLR,
   (char_u *)NULL, PV_NONE,
   (char_u *)FALSE
   SCRIPTID_INIT},
  {"arabic",      "arab", P_BOOL|P_VIM|P_CURSWANT,
   (char_u *)VAR_WIN, PV_ARAB,
   (char_u *)FALSE SCRIPTID_INIT},
  {"arabicshape", "arshape", P_BOOL|P_VIM|P_RCLR,
   (char_u *)&p_arshape, PV_NONE,
   (char_u *)TRUE SCRIPTID_INIT},
  {"allowrevins", "ari",  P_BOOL|P_VIM,
  ...
  {"backspace",   "bs",   P_STRING|P_VIM|P_COMMA|P_NODUP,
   (char_u *)&p_bs, PV_NONE,
   (char_u *)"indent,eol,start" SCRIPTID_INIT},
  {"backup",      "bk",   P_BOOL|P_VIM,
   (char_u *)&p_bk, PV_NONE,
   (char_u *)FALSE SCRIPTID_INIT},
  ...
  {"breakat",     "brk",  P_STRING|P_RALL|P_FLAGLIST,
   ...
   (char_u *)" \t!@*-+;:,./?"
   SCRIPTID_INIT},
  {"breakindent",   "bri",  P_BOOL|P_VIM|P_RWIN,
  ...
  {"casemap",     "cmp",   P_STRING|P_COMMA|P_NODUP,
   ...
   (char_u *)"internal,keepascii" SCRIPTID_INIT},
  ...
  {"charconvert",  "ccv", P_STRING|P_SECURE,
   ...
   (char_u *)""
   SCRIPTID_INIT},
  {"cindent",     "cin",  P_BOOL|P_VIM,
   (char_u *)&p_cin, PV_CIN,
   (char_u *)FALSE SCRIPTID_INIT},
  {"cinkeys",     "cink", P_STRING|P_ALLOCED|P_COMMA|P_NODUP,
   (char_u *)&p_cink, PV_CINK,
   (char_u *)"0{,0},0),:,0#,!^F,o,O,e" SCRIPTID_INIT},
  ...
  {"completeopt",   "cot",  P_STRING|P_COMMA|P_NODUP,
   ...
   (char_u *)"menu,preview" SCRIPTID_INIT},
  {"confirm",     "cf",   P_BOOL,
   (char_u *)&p_confirm, PV_NONE,
   (char_u *)FALSE SCRIPTID_INIT},
  {"copyindent",  "ci",   P_BOOL|P_VIM,
   (char_u *)&p_ci, PV_CI,
   (char_u *)FALSE SCRIPTID_INIT},
  {"cpoptions",   "cpo",  P_STRING|P_VIM|P_RALL|P_FLAGLIST,
   ...
   (char_u *)CPO_VIM
   SCRIPTID_INIT},
  {"cscopepathcomp", "cspc", P_NUM|P_VIM,
  ...
  {"cscopequickfix", "csqf", P_STRING|P_COMMA|P_NODUP,
   ...
   (char_u *)""
   SCRIPTID_INIT},
  {"cscoperelative", "csre", P_BOOL|P_VIM,
   (char_u *)&p_csre, PV_NONE,
   (char_u *)0L SCRIPTID_INIT},
  {"cscopetag",   "cst",  P_BOOL|P_VIM,
   (char_u *)&p_cst, PV_NONE,
   (char_u *)0L SCRIPTID_INIT},
  {"cscopetagorder", "csto", P_NUM|P_VIM,
   (char_u *)&p_csto, PV_NONE,
   (char_u *)0L SCRIPTID_INIT},
  {"cscopeverbose", "csverb", P_BOOL|P_VIM,
  ...
  {"fillchars",   "fcs",  P_STRING|P_RALL|P_COMMA|P_NODUP,
   ...
   (char_u *)"vert:|,fold:-" SCRIPTID_INIT},
  {"fkmap",       "fk",   P_BOOL,
  ...
  {"foldenable",  "fen",  P_BOOL|P_RWIN,
   ...
   (char_u *)TRUE SCRIPTID_INIT},
  {"foldexpr",    "fde",  P_STRING|P_ALLOCED|P_VIM|P_RWIN,
   (char_u *)VAR_WIN, PV_FDE,
   (char_u *)"0"
   SCRIPTID_INIT},
  {"foldignore",  "fdi",  P_STRING|P_ALLOCED|P_VIM|P_RWIN,
  ...
  {"foldlevelstart","fdls", P_NUM|P_CURSWANT,
   ...
   (char_u *)-1L SCRIPTID_INIT},
  {"foldmarker",  "fmr",  P_STRING|P_ALLOCED|P_VIM|
   P_RWIN|P_COMMA|P_NODUP,
   (char_u *)VAR_WIN, PV_FMR,
   (char_u *)"{{{,}}}" SCRIPTID_INIT},
  {"foldmethod",  "fdm",  P_STRING|P_ALLOCED|P_VIM|P_RWIN,
  ...
  {"foldopen",    "fdo",  P_STRING|P_COMMA|P_NODUP|P_CURSWANT,
   ...
   (char_u *)"block,hor,mark,percent,quickfix,search,tag,undo"
    SCRIPTID_INIT},
  {"foldtext",    "fdt",  P_STRING|P_ALLOCED|P_VIM|P_RWIN,
   (char_u *)VAR_WIN, PV_FDT,
   (char_u *)"foldtext()"
   SCRIPTID_INIT},
  {"formatexpr", "fex",   P_STRING|P_ALLOCED|P_VIM,
   (char_u *)&p_fex, PV_FEX,
   (char_u *)""
   SCRIPTID_INIT},
...
#  endif
  ...
  {"hkmap",       "hk",   P_BOOL|P_VIM,
   (char_u *)&p_hkmap, PV_NONE,
   (char_u *)FALSE SCRIPTID_INIT},
  {"hkmapp",      "hkp",  P_BOOL|P_VIM,
  ...
  {"incsearch",   "is",   P_BOOL|P_VIM,
   (char_u *)&p_is, PV_NONE,
   (char_u *)TRUE SCRIPTID_INIT},
  {"indentexpr", "inde",  P_STRING|P_ALLOCED|P_VIM,
   (char_u *)&p_inde, PV_INDE,
   (char_u *)""
   SCRIPTID_INIT},
  {"indentkeys", "indk",  P_STRING|P_ALLOCED|P_COMMA|P_NODUP,
   (char_u *)&p_indk, PV_INDK,
   (char_u *)"0{,0},:,0#,!^F,o,O,e" SCRIPTID_INIT},
  {"infercase",   "inf",  P_BOOL,
   (char_u *)&p_inf, PV_INF,
   (char_u *)FALSE SCRIPTID_INIT},
  {"insertmode",  "im",   P_BOOL|P_VIM,
   (char_u *)&p_im, PV_NONE,
   (char_u *)FALSE SCRIPTID_INIT},
...
#  endif
  ...
  {"listchars",   "lcs",  P_STRING|P_RALL|P_COMMA|P_NODUP,
   ...
   (char_u *)"tab:>\\ ,trail:-,extends:>,precedes:<,nbsp:+" SCRIPTID_INIT},
  ...
  {"mkspellmem",  "msm",  P_STRING|P_EXPAND|P_SECURE,
   ...
   (char_u *)"460000,2000,500" SCRIPTID_INIT},
  ...
  {"preserveindent", "pi", P_BOOL|P_VIM,
   (char_u *)&p_pi, PV_PI,
   (char_u *)FALSE SCRIPTID_INIT},
  ...
  {"sidescroll",  "ss",   P_NUM,
   (char_u *)&p_ss, PV_NONE,
   (char_u *)0L SCRIPTID_INIT},
  {"sidescrolloff", "siso", P_NUM|P_VIM|P_RBUF,
   (char_u *)&p_siso, PV_NONE,
   (char_u *)5L SCRIPTID_INIT},
  {"slowopen",    "slow", P_BOOL,
   (char_u *)NULL, PV_NONE,
   (char_u *)FALSE SCRIPTID_INIT},
  {"smartcase",   "scs",  P_BOOL|P_VIM,
   (char_u *)&p_scs, PV_NONE,
   (char_u *)FALSE SCRIPTID_INIT},
  {"smartindent", "si",   P_BOOL|P_VIM,
   (char_u *)&p_si, PV_SI,
   (char_u *)FALSE SCRIPTID_INIT},
  {"smarttab",    "sta",  P_BOOL|P_VIM,
   (char_u *)&p_sta, PV_NONE,
   (char_u *)TRUE SCRIPTID_INIT},
  {"softtabstop", "sts",  P_NUM|P_VIM,
   (char_u *)&p_sts, PV_STS,
   (char_u *)0L SCRIPTID_INIT},
  ...
  {"terse",       NULL,   P_BOOL,
   ...
   (char_u *)FALSE SCRIPTID_INIT},
  {"textwidth",   "tw",   P_NUM|P_VIM|P_RBUF,
   (char_u *)&p_tw, PV_TW,
   (char_u *)0L SCRIPTID_INIT},
  {"thesaurus",   "tsr",  P_STRING|P_EXPAND|P_COMMA|P_NODUP,
   (char_u *)&p_tsr, PV_TSR,
   (char_u *)"" SCRIPTID_INIT},
  {"tildeop",     "top",  P_BOOL|P_VIM,
   (char_u *)&p_to, PV_NONE,
   (char_u *)FALSE SCRIPTID_INIT},
  {"timeout",     "to",   P_BOOL,
  ...
  {"viminfo",     "vi",   P_STRING|P_COMMA|P_NODUP|P_SECURE,
   ...
   (char_u *)"'100,<50,s10,h,!"
   SCRIPTID_INIT},
  {"virtualedit", "ve",   P_STRING|P_COMMA|P_NODUP|P_VIM|P_CURSWANT,
   (char_u *)&p_ve, PV_NONE,
   (char_u *)""
   SCRIPTID_INIT},
