  ...
  FUNC_ATTR_WARN_UNUSED_RESULT
{
  ...
  case kOptValTypeString: {
    ...
    const char *newval_str = stropt_get_newval(nextchar, opt_idx, argp, varp, oldval_str, &op, flags);
...
OptVal optval_copy(OptVal o)
{
  ...
  case kOptValTypeNumber:
    return o;
  case kOptValTypeString:
    return STRING_OPTVAL(ref_string_copy(&o.data.string));
  }
  UNREACHABLE;
}
  ...
  FUNC_ATTR_NONNULL_ARG(2)
{
  ...
  case kOptValTypeString:
    return STRING_OPTVAL(ref_string_from_cstr(*(char **)varp));
  }
  UNREACHABLE;
}
  ...
  FUNC_ATTR_NONNULL_ARG(2)
{
  ...
  case kOptValTypeNumber:
    *(OptInt *)varp = value.data.number;
    return;
  case kOptValTypeString:
    *(char **)varp = ref_string_as_cstr(&value.data.string);
    return;
  }
  UNREACHABLE;
}
...
Object optval_as_object(OptVal o)
{
  ...
  case kOptValTypeString:
    return STRING_OBJ(ref_string_as_string(&o.data.string));
  }
  UNREACHABLE;
}
...
OptVal object_as_optval(Object o, bool *error)
{
  ...
  case kObjectTypeString:
    return STRING_OPTVAL(ref_string_new(o.data.string));
  default:
    *error = true;
    return NIL_OPTVAL;
  }
