...
/// Returns whether `sc` is a non-zero-width space character. Does no error checking on sc, but
/// will return `false` if sc is incorrectly formatted
bool schar_isspace(schar_T sc)
{
  // Use precoded lookup table. Since isspace_lut is a power of 2, no division is nesseary to
  // get bucket index.
#ifdef ORDER_BIG_ENDIAN
  static const schar_T isspace_lut[64] = {
    0xe28086,   0xe28087,   0xe28088,   0xe28089,   0xe2808a,   0xFF000000, 0xFF000000, 0xFF000000,
    0xFF000000, 0xFF000000, 0xFF000000, 0xFF000000, 0xFF000000, 0xFF000000, 0xFF000000, 0xe385a4,
    0xFF000000, 0xFF000000, 0xFF000000, 0xFF000000, 0xc2a0,     0xe1a08e,   0xFF000000, 0xFF000000,
    0xFF000000, 0xe2819f,   0xFF000000, 0xFF000000, 0xFF000000, 0xFF000000, 0xFF000000, 0xFF000000,
    0x20,       0xFF000000, 0xFF000000, 0xFF000000, 0xFF000000, 0xFF000000, 0xFF000000, 0xFF000000,
    0xFF000000, 0xe280af,   0xFF000000, 0xe38080,   0xFF000000, 0xFF000000, 0xFF000000, 0xFF000000,
    0xFF000000, 0xFF000000, 0xFF000000, 0xFF000000, 0xFF000000, 0xFF000000, 0xFF000000, 0xFF000000,
    0xe2a080,   0xFF000000, 0xe28080,   0xe28081,   0xe28082,   0xe28083,   0xe28084,   0xe28085,
  };
#else
  static const schar_T isspace_lut[64] = {
    0x8680e2,   0xFF000000, 0xFF000000, 0xFF000000, 0x8a80e2,   0x8ea0e1,   0xFF000000, 0xFF000000,
    0xFF000000, 0x9f81e2,   0xFF000000, 0x8180e2,   0xFF000000, 0xFF000000, 0xFF000000, 0x8580e2,
    0xFF000000, 0xFF000000, 0xFF000000, 0x8980e2,   0xFF000000, 0xFF000000, 0xFF000000, 0xFF000000,
    0x80a0e2,   0xaf80e2,   0x8080e2,   0x8080e3,   0xFF000000, 0xFF000000, 0x8480e2,   0xFF000000,
    0x20,       0xFF000000, 0x8880e2,   0xFF000000, 0xFF000000, 0xFF000000, 0xFF000000, 0xFF000000,
    0xFF000000, 0xFF000000, 0xFF000000, 0xFF000000, 0xFF000000, 0x8380e2,   0xFF000000, 0xFF000000,
    0xFF000000, 0x8780e2,   0xFF000000, 0xFF000000, 0xFF000000, 0xFF000000, 0xFF000000, 0xFF000000,
    0xa0c2,     0xFF000000, 0xFF000000, 0xFF000000, 0x8280e2,   0xFF000000, 0xFF000000, 0xa485e3,
  };
#endif
  // For input FF000000, it returns index 0 which, in both representations is not FF000000, so
  // all non-space characters are accounted for
  const schar_T hash = (sc >> 16) + (sc & 0xFF) - (sc >> 12);
  return isspace_lut[hash % ARRAY_SIZE(isspace_lut)] == sc;
}
