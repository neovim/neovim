...
static void grid_draw_bordertext(VirtText vt, int col, int winbl)
{
...
void grid_draw_border(ScreenGrid *grid, FloatConfig config, int *adj, int winbl)
{
  ...
  if (adj[0]) {
    ...
    if (config.title) {
      ...
      grid_draw_bordertext(config.title_chunks, title_col, winbl);
    }
    if (adj[1]) {
  ...
  if (adj[2]) {
    ...
    if (config.footer) {
      ...
      grid_draw_bordertext(config.footer_chunks, footer_col, winbl);
    }
    if (adj[1]) {
