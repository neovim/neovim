...
static int get_lit_string_tv(char_u **arg, typval_T *rettv,
                                     int evaluate);
...
static char_u *echo_string(typval_T *tv, char_u **tofree, char_u *
                                   numbuf,
                                   int copyID);
...
static int get_func_tv(char_u *name, int len, typval_T *rettv, char_u *
...
static dictitem_T *find_var(char_u *name, hashtab_T **htp,
                                    int no_autoload);
static dictitem_T *find_var_in_ht(hashtab_T *ht, int htname, char_u *
                                          varname,
                                          int no_autoload);
...
static int filter_map_one(typval_T *tv, char_u *expr, int map,
                                  int *remp);
...
static void find_some_match(typval_T *argvars, typval_T *rettv,
                                    int start);
