...
local target_field = 'src/nvim/tui/terminfo_field_defs.h'
...
local f_fields = assert(io.open(target_field, 'wb'))
f_fields:write([[
...
-- top level fields
for _, field in ipairs(wanted_bools) do
  f_fields:write('  FIELD(' .. field .. ', Boolean)\n')
end
for _, field in ipairs(wanted_ints) do
  f_fields:write('  FIELD(' .. field .. ', Integer)\n')
end

-- all the array type fields are defined by macros
f_fields:write([[
#undef FIELD
