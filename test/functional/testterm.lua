...
function M.setup_screen(extra_rows, cmd, cols, env, screen_opts)
  ...
  screen:add_extra_attr_ids({
    ...
    [109] = { bold = true, background = 121, foreground = Screen.colors.Grey0, blend = 0 },
    ...
    [117] = { background = 1, blend = 0 },
    [118] = { background = 1, reverse = true, blend = 0 },
    [119] = { background = 2, foreground = 8 },
    [120] = { foreground = Screen.colors.Black, background = 2 },
    [121] = { foreground = 130 },
    [122] = { background = 46, blend = 0 },
    [123] = { foreground = 2 },
    [124] = { foreground = 15, background = 1, blend = 0 },
    [125] = { background = 248, foreground = Screen.colors.Black, blend = 0 },
    [126] = { blend = 0 },
    [127] = { bold = true, blend = 0 },
  })
