...
describe('print', function()
  ...
  it('handles errors in __tostring', function()
    ...
    eq(
      'Vim(lua):E5108: Error executing lua E5114: Error while converting print argument #2: Xtest-functional-lua-overrides-luafile:0: abc',
  ...
  it('coerces error values into strings', function()
    ...
    eq('', exec_capture('luafile ' .. fname))
    eq(
      'Vim(lua):E5108: Error executing lua Xtest-functional-lua-overrides-luafile:0: my mistake',
      pcall_err(command, 'lua string_error()')
    )
    eq(
      'Vim(lua):E5108: Error executing lua Xtest-functional-lua-overrides-luafile:0: 1234',
