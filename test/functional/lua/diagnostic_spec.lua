...
describe('vim.diagnostic', function()
  ...
  describe('set()', function()
    it('validates its arguments', function()
      matches('expected a list of diagnostics', pcall_err(exec_lua, [[vim.diagnostic.set(1, 0, {lnum = 1, col = 2})]]))
    end)
  ...
  describe('open_float()', function()
    ...
    it('can add a prefix to diagnostics', function()
      ...
      eq(
        "Error executing lua: .../diagnostic.lua:0: prefix: expected 'string' or 'table' or 'function', got 42",
