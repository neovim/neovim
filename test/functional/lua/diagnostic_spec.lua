...
describe('vim.diagnostic', function()
  ...
  describe('jump()', function()
    ...
    it(
      'finds next diagnostic at the end of the line if diagnostic is set after last character in line',
      function()
        exec_lua(function()
          vim.api.nvim_set_current_buf(_G.diagnostic_bufnr)
    ...
    it(
      'finds previous diagnostic at the end of the line if diagnostic is set after last character in line',
      function()
        exec_lua(function()
          vim.api.nvim_set_current_buf(_G.diagnostic_bufnr)
