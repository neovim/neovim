...
describe('TUI', function()
  ...
  it('allows grid to assume wider ambiguous-width characters than host terminal #19686', function()
    ...
    child_session:request('nvim_win_set_option_value', 'cursorline', true, {win=0})
    child_session:request('nvim_win_set_option_value', 'list', true, {win=0})
    child_session:request('nvim_win_set_option_value', 'listchars', 'eol:$', {win=0})
    feed_data('gg')
