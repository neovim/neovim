...
describe('tui guicursor handling', function()
  ...
  local gen = function(guicursor, input, pattern)
    ...
    if iswin() then
      ...
      nvim('command', "let j = jobstart([ '".. helpers.nvim_prog.."', '-u', 'NONE', '-i', 'NONE', '--cmd', 'set noswapfile noshowcmd noruler shortmess=I guicursor="..guicursor.."' ], g:job_opts)")
      -- to send data to the job
      nvim('command', 'call jobsend(j,"'..input..'")')
  ...
  it('checking for guicursor', function()
