  ...
  describe('au TabNewEntered', function()
    ...
    describe('with FILE as <afile>', function()
      it('matches when opening a new tab for FILE', function()
        ...
        eq('tabnewentered:4:4\ntabnewentered:match', nvim('exec', 'tabnew Xtest-tabnewentered', true))
      end)
    end)
...
describe('tabpage/previous', function()
  ...
  it('switches to previous after switching to last tab', switches_to_previous_after_switching_to_last_tab '<C-Tab>')
  it('switches to previous after switching to last tab', switches_to_previous_after_switching_to_last_tab ':tabn #<CR>')
  ...
  it('cmdline-win prevents tab switch via <C-W>g<Tab>', cmdline_win_prevents_tab_switch('<C-W>g<Tab>', 1))
  it('cmdline-win prevents tab switch via <C-Tab>', cmdline_win_prevents_tab_switch('<C-Tab>', 0))
  it('cmdline-win prevents tab switch via :tabn #<CR>', cmdline_win_prevents_tab_switch(':tabn #<CR>', 0))
