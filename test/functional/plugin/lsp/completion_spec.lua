...
describe('vim.lsp.completion: item conversion', function()
  ...
  it('CompletionItemKind: should generate symbol and highlight group', function()
    local completion_list = {
      { label = 'Text', kind = 1 },
      { label = 'Method', kind = 2 },
    ...
    local expected = {
      { word = 'Text', kind_hlgroup = '@lsp.kind.text', kind = 1 },
      { word = 'Method', kind_hlgroup = '@lsp.kind.method', kind = 2 },
      { word = 'Function', kind_hlgroup = '@lsp.kind.function', kind = 3 },
      { word = 'Constructor', kind_hlgroup = '@lsp.kind.constructor', kind = 4 },
      { word = 'Field', kind_hlgroup = '@lsp.kind.field', kind = 5 },
      { word = 'Variable', kind_hlgroup = '@lsp.kind.variable', kind = 6 },
      { word = 'Class', kind_hlgroup = '@lsp.kind.class', kind = 7 },
      { word = 'Interface', kind_hlgroup = '@lsp.kind.interface', kind = 8 },
      { word = 'Module', kind_hlgroup = '@lsp.kind.module', kind = 9 },
      { word = 'Property', kind_hlgroup = '@lsp.kind.property', kind = 10 },
      { word = 'Unit', kind_hlgroup = '@lsp.kind.unit', kind = 11 },
      { word = 'Value', kind_hlgroup = '@lsp.kind.value', kind = 12 },
      { word = 'Enum', kind_hlgroup = '@lsp.kind.enum', kind = 13 },
      { word = 'Keyword', kind_hlgroup = '@lsp.kind.keyword', kind = 14 },
      { word = 'Snippet', kind_hlgroup = '@lsp.kind.snippet', kind = 15 },
      { word = 'Color', kind_hlgroup = '@lsp.kind.color', kind = 16 },
      { word = 'File', kind_hlgroup = '@lsp.kind.file', kind = 17 },
      { word = 'Reference', kind_hlgroup = '@lsp.kind.reference', kind = 18 },
      { word = 'Folder', kind_hlgroup = '@lsp.kind.folder', kind = 19 },
      { word = 'EnumMember', kind_hlgroup = '@lsp.kind.enumMember', kind = 20 },
      { word = 'Constant', kind_hlgroup = '@lsp.kind.constant', kind = 21 },
      { word = 'Struct', kind_hlgroup = '@lsp.kind.struct', kind = 22 },
      { word = 'Event', kind_hlgroup = '@lsp.kind.event', kind = 23 },
      { word = 'Operator', kind_hlgroup = '@lsp.kind.operator', kind = 24 },
      { word = 'TypeParameter', kind_hlgroup = '@lsp.kind.typeParameter', kind = 25 },
    }
