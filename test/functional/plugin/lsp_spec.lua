...
describe('LSP', function()
  ...
  describe('lsp._cmd_parts test', function()
    ...
    it('should invalid cmd argument', function()
      eq('Error executing lua: .../lsp.lua:0: cmd: expected list, got nvim', pcall_err(_cmd_parts, 'nvim'))
      eq(
    ...
    it('should choose right completion option', function()
      ...
      local expected = {
        ...
        },
        {
          ...
          user_data = {
            nvim = {
              lsp = { completion_item = { label = 'foocar', sortText = 'f', textEdit = { newText = 'foobar' } } },
            },
          },
        },
        {
