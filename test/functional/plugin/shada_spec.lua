  ...
  describe('function shada#sd_to_strings', function()
    ...
    it('works with unknown items', function()
      ...
      sd2strings_eq({
        ...
        '[{"type": %s, "timestamp": 0, "length": 1, "data": 100}]'
      ):format(sp('integer', '[1, 1, 35, 6]')))
    end)
  ...
  it('works', function()
    ...
    local exp = {
      ...
      },
      {
        ...
        {
          { 'ShaDaMsgpackArray', 'ShaDaMsgpackMap', 'ShaDaMsgpackBinaryString', 'ShaDaMsgpackBinaryStringEscape' },
          '\\0',
        },
