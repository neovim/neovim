...
describe(':Tutor', function()
  ...
  it("removing a line doesn't affect highlight/mark of other lines", function()
    ...
    screen:expect([[
      ...
      {0:  }                                                                               |
      {0:  }{1: Type }"dd"{1: to delete a whole line. }                                              |
      {0:  }                                                                               |
      ...
      {0:  }                                                                               |
      {0:  }{1: Press }"u"{1: to undo the last commands, }"U"{1: to fix a whole line. }                    |
      {0:  }                                                                               |
  ...
  it("inserting text at start of line doesn't affect highlight/sign", function()
    ...
    screen:expect([[
      ...
      {0:  }                                                                               |
      {0:  }{1: Press }"x"{1: to delete the character under the cursor. }                            |
      {0:  }                                                                               |
