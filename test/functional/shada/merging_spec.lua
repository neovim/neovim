...
local nvim_command, funcs, curbufmeths, eq = helpers.command, helpers.funcs, helpers.curbufmeths, helpers.eq
local exc_exec, exec_capture = helpers.exc_exec, helpers.exec_capture

local shada_helpers = require('test.functional.shada.helpers')
local reset, clear, get_shada_rw = shada_helpers.reset, shada_helpers.clear, shada_helpers.get_shada_rw
...
describe('ShaDa jumps support code', function()
  ...
  it('merges JUMPLISTSIZE jumps when writing', function()
    ...
    local shada = ''
    for i = 1, 100 do
      shada = shada .. ('\008%c\018\131\162mX\195\161f\196\006' .. mock_file_path .. 'c\161l%c'):format(i, i)
    ...
    for i = 1, 101 do
      local t = i * 2
      shada = shada .. ('\008\204%c\019\131\162mX\195\161f\196\006' .. mock_file_path .. 'c\161l\204%c'):format(t, t)
...
describe('ShaDa changes support code', function()
  ...
  it('merges JUMPLISTSIZE changes when writing', function()
    ...
    local shada = ''
    for i = 1, 100 do
      shada = shada .. ('\011%c\018\131\162mX\195\161f\196\006' .. mock_file_path .. 'c\161l%c'):format(i, i)
      changes[i] = { line = i }
    end
    wshada(shada)
    eq(0, exc_exec(sdrcmd()))
    ...
    for i = 1, 101 do
      local t = i * 2
      shada = shada .. ('\011\204%c\019\131\162mX\195\161f\196\006' .. mock_file_path .. 'c\161l\204%c'):format(t, t)
