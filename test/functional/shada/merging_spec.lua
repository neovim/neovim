...
describe('ShaDa marks support code', function()
  ...
  function()
    wshada('\007\001\018\131\162mX\195\161f' .. header .. mock_file_path .. '-\161nA')
    eq(0, exc_exec(sdrcmd()))
    wshada('\007\000\018\131\162mX\195\161f' .. header .. mock_file_path .. '?\161nA')
    eq(0, exc_exec(sdrcmd()))
  ...
  function()
    wshada('\007\001\018\131\162mX\195\161f' .. header .. mock_file_path .. '-\161nA')
    eq(0, exc_exec(sdrcmd()))
    wshada('\007\002\018\131\162mX\195\161f' .. header .. mock_file_path .. '?\161nA')
    eq(0, exc_exec(sdrcmd()))
    nvim_command('normal! `A')
    eq('?', funcs.fnamemodify(curbufmeths.get_name(), ':t'))
  end)
  ...
  function()
    ...
    funcs.setline(1, {'-', '?'})
    wshada('\010\001\017\131\161l\001\161f' .. header .. mock_file_path .. '-\161na')
    eq(0, exc_exec(sdrcmd()))
    wshada('\010\000\017\131\161l\002\161f' .. header .. mock_file_path .. '-\161na')
    eq(0, exc_exec(sdrcmd()))
    nvim_command('normal! `a')
    eq('-', funcs.getline('.'))
  end)
  ...
  function()
    ...
    wshada('\010\001\017\131\161l\001\161f' .. header .. mock_file_path .. '-\161na')
    eq(0, exc_exec(sdrcmd()))
    wshada('\010\001\017\131\161l\002\161f' .. header .. mock_file_path .. '-\161na')
    eq(0, exc_exec(sdrcmd()))
    nvim_command('normal! `a')
    eq('-', funcs.getline('.'))
  end)
  ...
  function()
    ...
    wshada('\010\001\017\131\161l\001\161f' .. header .. mock_file_path .. '-\161na')
    eq(0, exc_exec(sdrcmd()))
    wshada('\010\002\017\131\161l\002\161f' .. header .. mock_file_path .. '-\161na')
    eq(0, exc_exec(sdrcmd()))
    nvim_command('normal! `a')
    eq('?', funcs.getline('.'))
  end)
...
describe('ShaDa jumps support code', function()
  ...
  it('merges jumps when reading', function()
    wshada('\008\001\018\131\162mX\195\161f' .. header .. mock_file_path .. 'c\161l\002'
           .. '\008\004\018\131\162mX\195\161f' .. header .. mock_file_path .. 'd\161l\002'
           .. '\008\007\018\131\162mX\195\161f' .. header .. mock_file_path .. 'e\161l\002')
    eq(0, exc_exec(sdrcmd()))
    wshada('\008\001\018\131\162mX\195\161f' .. header .. mock_file_path .. 'c\161l\002'
           .. '\008\004\018\131\162mX\195\161f' .. header .. mock_file_path .. 'd\161l\003'
           .. '\008\007\018\131\162mX\195\161f' .. header .. mock_file_path .. 'f\161l\002')
    eq(0, exc_exec(sdrcmd()))
  ...
  it('merges JUMPLISTSIZE jumps when writing', function()
    ...
    local shada = ''
    for i = 1,100 do
      shada = shada .. ('\008%c\018\131\162mX\195\161f' .. header .. mock_file_path .. 'c\161l%c'
                       ):format(i, i)
    ...
    for i = 1,101 do
      local t = i * 2
      shada = shada .. (
          '\008\204%c\019\131\162mX\195\161f' .. header .. mock_file_path .. 'c\161l\204%c'
          ):format(t, t)
...
describe('ShaDa changes support code', function()
  ...
  it('merges changes when reading', function()
    ...
    wshada('\011\001\018\131\162mX\195\161f' .. header .. mock_file_path .. 'c\161l\001'
           .. '\011\004\018\131\162mX\195\161f' .. header .. mock_file_path .. 'c\161l\002'
           .. '\011\007\018\131\162mX\195\161f' .. header .. mock_file_path .. 'c\161l\003')
    eq(0, exc_exec(sdrcmd()))
    wshada('\011\001\018\131\162mX\194\161f' .. header .. mock_file_path .. 'c\161l\001'
           .. '\011\004\018\131\162mX\195\161f' .. header .. mock_file_path .. 'c\161l\005'
           .. '\011\008\018\131\162mX\195\161f' .. header .. mock_file_path .. 'c\161l\004')
    eq(0, exc_exec(sdrcmd()))
    eq('\n'
  ...
  it('merges JUMPLISTSIZE changes when writing', function()
    ...
    local shada = ''
    for i = 1,100 do
      shada = shada .. ('\011%c\018\131\162mX\195\161f' .. header .. mock_file_path .. 'c\161l%c'
                       ):format(i, i)
      changes[i] = {line=i}
    end
    wshada(shada)
    ...
    for i = 1,101 do
      local t = i * 2
      shada = shada .. (
          '\011\204%c\019\131\162mX\195\161f' .. header .. mock_file_path .. 'c\161l\204%c'
          ):format(t, t)
