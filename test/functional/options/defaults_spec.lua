...
describe('XDG-based defaults', function()
  ...
  describe('with commas', function()
    ...
    it('are escaped properly', function()
      ...
      eq(
        '.,\\,=\\,=\\,' .. path_sep .. data_dir .. '' .. path_sep .. 'backup' .. (path_sep):rep(2),
      ...
      eq(
        '\\,=\\,=\\,' .. path_sep .. '' .. data_dir .. '' .. path_sep .. 'undo' .. (path_sep):rep(2),
        meths.get_option('undodir')
      )
      eq(
        '\\,=\\,=\\,' .. path_sep .. '' .. data_dir .. '' .. path_sep .. 'view' .. (path_sep):rep(2),
...
describe('stdpath()', function()
  ...
  context('returns a List', function()
    ...
    describe('with "config_dirs"', function()
      ...
      behaves_like_dir_list_env("doesn't expand $VAR and $IBLES", 'config_dirs', 'XDG_CONFIG_DIRS', {
        '$HOME',
        '$TMP',
      }, {
