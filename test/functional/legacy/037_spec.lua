...
describe('37', function()
  ...
  it('is working', function()
    ...
    --expect_scroll_pos(22, 20, 26)
    execute('set scrollbind')
    -- -- start of tests --.
    -- TEST scrolling down.
    feed('L')
    --expect_scroll_pos(24, 20, 26)
    feed('5j')
    --expect_scroll_pos(29, 25, 31)
    feed('H')
    --expect_scroll_pos(27, 25, 31)
    feed('yy')
    feed('<C-W>b')
    expect_winnr(3)
    feed('p')
    ...
    expect_winnr(1)
    feed('H')
    -- Window 1 was affected by movements in window 2 because of 'scrollbind'.
    --expect_scroll_pos(8, 6, 13)
    feed('yy')
    feed('<C-W>b')
    feed('p')
    feed('r1')
    ...
    --expect_scroll_pos(8, 6, 13)
    feed('L')
    --expect_scroll_pos(11, 6, 13)
    feed('6j')
    --expect_scroll_pos(17, 12, 19)
    feed('H')
    --expect_scroll_pos(14, 12, 19)
    feed('yy')
    feed('<C-W>b')
    feed('p')
    feed('r2')
    feed('<C-W>k')
    expect_winnr(2)
    -- Window 2 was affected by movements in window 1 because of 'scrollbind'.
    --expect_scroll_pos(31, 29, 35)
    feed('H')
    --expect_scroll_pos(31, 29, 35)
    feed('yy')
    feed('<C-W>b')
