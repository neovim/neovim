...
describe('float window', function()
  ...
  local function with_ext_multigrid(multigrid)
    ...
    it('#previewpopup option', function()
      ...
      if multigrid then
        screen:expect({
          ...
          float_pos = {
            [5] = { 1002, 'NW', 1, 1, 1, false, 50, 1, 1, 1 },
          },
          win_viewport = {
            [2] = { win = 1000, topline = 0, botline = 2, curline = 0, curcol = 0, linecount = 1, sum_scroll_delta = 0 },
            [5] = { win = 1002, topline = 0, botline = 2, curline = 0, curcol = 0, linecount = 1, sum_scroll_delta = 0 },
          ...
          win_viewport_margins = {
            [2] = { bottom = 0, left = 0, right = 0, top = 0, win = 1000 },
            [5] = { bottom = 1, left = 1, right = 1, top = 1, win = 1002 },
          },
        })
      else
        screen:expect([[
    ...
    it('invalid argument in previewpopup', function()
      ...
      eq('nvim_exec2(), line 1: Vim(set):E474: Invalid argument: previewpopup=height:10,border:nonexist', err)
    end)
  end
