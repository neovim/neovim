...
describe('float window', function()
  ...
  it('win_execute() should work', function()
    ...
    local win =
      api.nvim_open_win(buf, false, { relative = 'win', width = 16, height = 1, row = 0, col = 10 })
  ...
  it("win_execute() call commands that are not allowed when 'hidden' is not set", function()
    ...
    local win =
      api.nvim_open_win(buf, true, { relative = 'win', width = 16, height = 1, row = 0, col = 10 })
    eq(
      'Vim(close):E37: No write since last change (add ! to override)',
      pcall_err(fn.win_execute, win, 'close')
    )
    eq(
      'Vim(bdelete):E89: No write since last change for buffer 2 (add ! to override)',
      pcall_err(fn.win_execute, win, 'bdelete')
    )
    fn.win_execute(win, 'bwipe!')
  end)
  ...
  it('no crash with bufpos and non-existent window', function()
    ...
    eq(
      ...
      pcall_err(
        ...
        buf,
        true,
        { relative = 'win', win = closed_win, width = 1, height = 1, bufpos = { 0, 0 } }
      )
    )
    assert_alive()
  end)
  ...
  it("should re-apply 'style' when present", function()
    local float_opts =
      { style = 'minimal', relative = 'editor', row = 1, col = 1, width = 1, height = 1 }
    local float_win = api.nvim_open_win(0, true, float_opts)
  ...
  it('win_splitmove() can move float into a split', function()
    ...
    local win1 =
      api.nvim_open_win(0, true, { relative = 'editor', row = 1, col = 1, width = 5, height = 5 })
    fn.win_splitmove(win1, 1001, { vertical = true })
    eq(
      { 'col', { { 'row', { { 'leaf', win1 }, { 'leaf', 1001 } } }, { 'leaf', 1000 } } },
      fn.winlayout()
    )
    ...
    eq(
      ...
      pcall_err(fn.win_splitmove, win1, win2, { vertical = true })
    )
  end)
  ...
  describe('with multiple tabpages and multiple listed buffers,', function()
    ...
    describe('closing the last non-floating window', function()
      ...
      describe('gives E5601 when there are non-closeable floating windows', function()
        ...
        it('if called from non-floating window', function()
          eq(
            'Vim:E5601: Cannot close window, only floating window would remain',
  ...
  local function with_ext_multigrid(multigrid)
    ...
    it('can be created and reconfigured', function()
      ...
      local win = api.nvim_open_win(
        buf,
        false,
        { relative = 'editor', width = 20, height = 2, row = 2, col = 5 }
      )
      local expected_pos = {
    ...
    it('return their configuration', function()
      ...
      local win = api.nvim_open_win(
        buf,
        false,
        { relative = 'editor', width = 20, height = 2, row = 3, col = 5, zindex = 60 }
      )
      local expected = {
        anchor = 'NW',
        col = 5,
    ...
    it('defaults to NormalFloat highlight and inherited options', function()
      ...
      local win = api.nvim_open_win(
        0,
        false,
        { relative = 'editor', width = 20, height = 4, row = 4, col = 10 }
      )
      if multigrid then
        screen:expect {
          grid = [[
      ...
      api.nvim_open_win(
        0,
        false,
        { relative = 'win', row = 3, col = 3, width = 12, height = 3, style = 'minimal' }
      )
    ...
    it('can have border', function()
      ...
      api.nvim_win_set_config(
        win,
        { border = { 'x', { 'å', 'ErrorMsg' }, { '\\' }, { 'n̈̊', 'Search' } } }
      )
      eq({
        'x',
        { 'å', 'ErrorMsg' },
    ...
    it('border with title and footer', function()
      ...
      api.nvim_win_set_config(
        win,
        { title = 'Center', title_pos = 'center', footer = 'Center', footer_pos = 'center' }
      )
      if multigrid then
        screen:expect {
          grid = [[
      ...
      api.nvim_win_set_config(
        win,
        { title = 'Right', title_pos = 'right', footer = 'Left', footer_pos = 'left' }
      )
      if multigrid then
        screen:expect {
          grid = [[
    ...
    it('with border show popupmenu', function()
      ...
      api.nvim_open_win(
        buf,
        true,
        { relative = 'editor', width = 9, height = 3, row = 0, col = 5, border = 'double' }
      )
      feed 'G'
    ...
    it('API has proper error messages', function()
      ...
      eq(
        ...
        pcall_err(
          ...
          buf,
          false,
          { width = 20, height = 2, relative = 'editor', row = 0, col = 0, vertical = true }
        )
      )
      eq(
        ...
        pcall_err(
          ...
          buf,
          false,
          { width = 20, height = 2, relative = 'editor', row = 0, col = 0, split = 'left' }
        )
      )
      eq(
      ...
      eq(
        ...
        pcall_err(
          ...
          buf,
          false,
          { width = 20, height = 2, relative = 'shell', row = 0, col = 0 }
        )
      )
      eq(
      ...
      eq(
        ...
        pcall_err(
          ...
          buf,
          false,
          { width = -1, height = 2, relative = 'editor', row = 0, col = 0 }
        )
      )
      eq(
        ...
        pcall_err(
          ...
          buf,
          false,
          { width = 20, height = -1, relative = 'editor', row = 0, col = 0 }
        )
      )
      eq(
        "'height' key must be a positive Integer",
        pcall_err(
          ...
          buf,
          false,
          { width = 20, height = 0, relative = 'editor', row = 0, col = 0 }
        )
      )
      eq(
        "Must specify 'width'",
      ...
      eq(
        ...
        pcall_err(
          ...
          buf,
          false,
          { relative = 'editor', row = 0, col = 0, width = 2 }
        )
      )
    end)
    ...
    it('can be placed relative window or cursor', function()
      ...
      local win = api.nvim_open_win(
        buf,
        false,
        { relative = 'win', width = 20, height = 2, row = 0, col = 10 }
      )
      if multigrid then
        screen:expect {
          grid = [[
      ...
      api.nvim_win_set_config(
        win,
        { relative = 'win', win = oldwin, row = 1, col = 10, anchor = 'NW' }
      )
      if multigrid then
        screen:expect {
          grid = [[
      ...
      api.nvim_win_set_config(
        win,
        { relative = 'win', win = oldwin, row = 3, col = 39, anchor = 'SE' }
      )
      if multigrid then
        screen:expect {
          grid = [[
    ...
    it('always anchor to corner including border', function()
      ...
      local win = api.nvim_open_win(
        buf,
        false,
        { relative = 'cursor', width = 9, height = 2, row = 1, col = -2, border = 'double' }
      )
    ...
    it('can be placed relative text in a window', function()
      ...
      local win = api.nvim_open_win(
        buf,
        false,
        { relative = 'win', width = 12, height = 1, bufpos = { 1, 32 } }
      )
      if multigrid then
        screen:expect {
          grid = [[
      ...
      api.nvim_win_set_config(
        win,
        { relative = 'win', bufpos = { 1, 32 }, anchor = 'NW', col = -2 }
      )
      if multigrid then
        screen:expect {
          grid = [[
    ...
    it('validates cursor even when window is not entered', function()
      ...
      api.nvim_open_win(
        buf,
        false,
        { relative = 'editor', width = 20, height = 1, row = 3, col = 1 }
      )
      if multigrid then
        screen:expect {
          grid = [[
    ...
    it('handles resized screen', function()
      ...
      local win = api.nvim_open_win(
        buf,
        false,
        { relative = 'editor', width = 15, height = 4, row = 2, col = 10 }
      )
      local expected_pos = {
    ...
    it('does not crash with inccommand #9379', function()
      ...
      api.nvim_open_win(
        buf,
        true,
        { relative = 'editor', width = 30, height = 3, row = 2, col = 0 }
      )
    ...
    describe('and completion', function()
      before_each(function()
        ...
        local win = api.nvim_open_win(
          buf,
          true,
          { relative = 'editor', width = 12, height = 4, row = 2, col = 5 }
        )
    ...
    describe('float shown after pum', function()
      ...
      before_each(function()
        ...
        win = api.nvim_open_win(
          buf,
          false,
          { relative = 'cursor', width = 12, height = 2, row = 1, col = 10 }
        )
        if multigrid then
          screen:expect {
            grid = [[
    ...
    describe('handles :wincmd', function()
      ...
      it(':quit two floats in a row', function()
        ...
        api.nvim_open_win(
          0,
          true,
          { relative = 'editor', width = 20, height = 2, row = 4, col = 8 }
        )
        if multigrid then
          screen:expect {
            grid = [[
      ...
      it('J (float with border)', function()
        api.nvim_win_set_config(
          win,
          { relative = 'editor', width = 20, height = 2, row = 2, col = 5, border = 'single' }
        )
        if multigrid then
          screen:expect {
            grid = [[
    ...
    it('left drag changes visual selection in float window', function()
      ...
      api.nvim_open_win(
        buf,
        false,
        { relative = 'editor', width = 20, height = 3, row = 2, col = 5 }
      )
      if multigrid then
        screen:expect {
          grid = [[
    ...
    it('left drag changes visual selection in float window with border', function()
      ...
      api.nvim_open_win(
        buf,
        false,
        { relative = 'editor', width = 20, height = 3, row = 0, col = 5, border = 'single' }
      )
      if multigrid then
        screen:expect {
          grid = [[
    ...
    it('left drag changes visual selection in float window with winbar', function()
      ...
      local float_win = api.nvim_open_win(
        buf,
        false,
        { relative = 'editor', width = 20, height = 4, row = 1, col = 5 }
      )
    ...
    it("'winblend' option", function()
      ...
      local win = api.nvim_open_win(
        buf,
        false,
        { relative = 'editor', width = 15, height = 3, row = 2, col = 5 }
      )
      if multigrid then
        screen:expect {
          grid = [[
    ...
    it('can use winbar', function()
      ...
      local win1 = api.nvim_open_win(
        buf,
        false,
        { relative = 'editor', width = 15, height = 3, row = 1, col = 5 }
      )
      ...
      api.nvim_win_set_config(
        win1,
        { relative = 'editor', width = 15, height = 4, row = 0, col = 4, border = 'single' }
      )
    ...
    it('with rightleft and border #22640', function()
      local float_opts =
        { relative = 'editor', width = 5, height = 3, row = 1, col = 1, border = 'single' }
      api.nvim_open_win(api.nvim_create_buf(false, false), true, float_opts)
    ...
    it('float window with hide option', function()
      ...
      local win = api.nvim_open_win(
        buf,
        false,
        { relative = 'editor', width = 10, height = 2, row = 2, col = 5, hide = true }
      )
      local expected_pos = {
        [4] = { 1001, 'NW', 1, 2, 5, true },
      }
      ...
      local win3 = api.nvim_open_win(
        buf,
        true,
        { relative = 'editor', width = 4, height = 4, row = 2, col = 5, hide = false }
      )
      api.nvim_win_set_config(win, { hide = true })
      feed('<C-W>w')
    ...
    it('correctly placed in or above message area', function()
      local float_opts =
        { relative = 'editor', width = 5, height = 1, row = 100, col = 1, border = 'single' }
    ...
    it('error when relative to itself', function()
      ...
      eq(
        'floating window cannot be relative to itself',
        pcall_err(api.nvim_win_set_config, winid, config)
      )
    end)
    ...
    it('bufpos out of range', function()
      ...
      local config =
        { relative = 'win', width = 5, height = 2, row = 0, col = 0, bufpos = { 3, 3 } }
    ...
    it('winborder option', function()
      ...
      eq(
        'Vim(set):E474: Invalid argument: winborder=custom',
        pcall_err(command, 'set winborder=custom')
      )
    end)
  end
