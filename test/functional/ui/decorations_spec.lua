...
describe('extmark decorations', function()
  ...
  it('highlight can combine multiple groups', function()
    ...
    insert([[example text]])
    id = api.nvim_buf_set_extmark(0, ns, 0, 0, { end_row=1, hl_group = {} })
    screen:expect([[
      example tex^t                                      |
      {1:~                                                 }|
                                                        |
    ...
    api.nvim_buf_clear_namespace(0, ns, 0, -1)
    id = api.nvim_buf_set_extmark(0, ns, 0, 0, { end_row=1, hl_group = {'Group1'} })
    screen:expect([[
      {45:example tex^t}                                      |
      {1:~                                                 }|
                                                        |
    ...
    api.nvim_buf_clear_namespace(0, ns, 0, -1)
    id = api.nvim_buf_set_extmark(0, ns, 0, 0, { end_row = 1, hl_group = {'Group1', 'Group2'} })
    screen:expect([[
      {46:example tex^t}                                      |
      {1:~                                                 }|
                                                        |
    ...
    api.nvim_buf_clear_namespace(0, ns, 0, -1)
    id = api.nvim_buf_set_extmark(0, ns, 0, 0, { end_row = 1, hl_group = {'Group1', 'Group2', 'Group3'}, hl_eol=true })
    screen:expect([[
      {47:example tex^t                                      }|
      {1:~                                                 }|
                                                        |
