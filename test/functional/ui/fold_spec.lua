...
describe("folded lines", function()
  ...
  it("works with multibyte text", function()
     -- to get same behavior on master
    feed_command("set mco=6")

    eq(true, meths.get_option('arabicshape'))
    insert([[
      å x̨̣̘̫̲͚͎̎͂̀̂͛͛̾͢͟ العَرَبِيَّة
      möre text]])
    screen:expect([[
      å x̎͂̀̂͛͛ ﺎﻠﻋَﺮَﺒِﻳَّﺓ                             |
      möre tex^t                               |
      {1:~                                       }|
      {1:~                                       }|
      {1:~                                       }|
    ...
    feed('vkzf')
    screen:expect([[
      {5:^+--  2 lines: å x̎͂̀̂͛͛ ﺎﻠﻋَﺮَﺒِﻳَّﺓ···············}|
      {1:~                                       }|
      {1:~                                       }|
      {1:~                                       }|
      {1:~                                       }|
    ...
    screen:expect([[
      {5:^+--  2 lines: å x̎͂̀̂͛͛ العَرَبِيَّة···············}|
      {1:~                                       }|
      {1:~                                       }|
      {1:~                                       }|
      {1:~                                       }|
    ...
    screen:expect([[
      {7:+ }{5:  1 ^+--  2 lines: å x̎͂̀̂͛͛ العَرَبِيَّة·········}|
      {7:  }{1:~                                     }|
      {7:  }{1:~                                     }|
      {7:  }{1:~                                     }|
      {7:  }{1:~                                     }|
    ...
    -- seems wrong, but matches master behavior
