...
describe('ext_hlstate detailed highlights', function()
  ...
  it('work with combined UI and syntax highlights', function()
    ...
    screen:expect(
      ...
      {
        [1] = { { foreground = Screen.colors.Magenta }, { { hi_name = 'Constant', kind = 'syntax' } } },
        [2] = { { background = Screen.colors.Yellow }, { { hi_name = 'Search', ui_name = 'Search', kind = 'ui' } } },
        [3] = { { bold = true, foreground = Screen.colors.Brown }, { { hi_name = 'Statement', kind = 'syntax' } } },
  ...
  it('work with window-local highlights', function()
    screen:set_default_attr_ids {
      ...
      [9] = {
        ...
        { { hi_name = 'Statement', ui_name = 'NormalNC', kind = 'ui' } },
      },
