...
describe('conceal-aware wrapping (#14409)', function()
  ...
  it('_on_conceal provider conceal reflows (materialized into the marktree)', function()
    -- A provider that materializes intra-line conceal on demand via the _on_conceal callback (as an
    -- ordinary marktree extmark) DOES reflow, because the off-draw geometry can read it. This is
    -- how tree-sitter @conceal becomes wrap-aware.
