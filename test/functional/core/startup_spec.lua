...
describe('sysinit', function()
  ...
  it('prefers XDG_CONFIG_DIRS over VIM', function()
    ...
    eq('loaded 1 xdg 1 vim 0', eval 'printf("loaded %d xdg %d vim %d", g:loaded, get(g:, "xdg", 0), get(g:, "vim", 0))')
  end)
  ...
  it('uses VIM if XDG_CONFIG_DIRS unset', function()
    ...
    eq('loaded 1 xdg 0 vim 1', eval 'printf("loaded %d xdg %d vim %d", g:loaded, get(g:, "xdg", 0), get(g:, "vim", 0))')
  end)
