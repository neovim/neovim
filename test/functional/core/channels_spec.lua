...
describe('channels', function()
  ...
  it('can use stdio channel', function()
    ...
    expect_twostreams(
      { { 'notification', 'stdout', { id, { "[1, [''], 'stdin']" } } }, { 'notification', 'stdout', { id, { '' } } } },
      { { 'notification', 'stderr', { id, { '*dies*' } } }, { 'notification', 'stderr', { id, { '' } } } }
    )
  ...
  it('can use buffered output mode', function()
    ...
    eq({ 'notification', 'stdout', { id, { '10 PRINT "NVIM"', '20 GOTO 10', '' } } }, next_msg())
  ...
  it('can use buffered output mode with no stream callback', function()
    ...
    eq({ 'notification', 'exit', { id, 0, { '10 PRINT "NVIM"', '20 GOTO 10', '' } } }, next_msg())
