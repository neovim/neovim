...
describe('API', function()
  ...
  describe('nvim_get_option_value, nvim_set_option_value', function()
    ...
    it('can get default option values for filetypes', function()
      ...
      matches( -- Watch out; this error is very chonky!
      ...
      eq(
        [[Vim(call):E5555: API call: FileType autocommands are disabled]],
      ...
      -- Returning the global value copied from curbuf will continue to suffice, I guess.
    ...
    it('sets dummy buffer options without side-effects', function()
      exec [[
        ...
        autocmd FileType * ++once let g:bufhidden = &l:bufhidden
                               ...
                               "\ Buffer should also have a memline.
