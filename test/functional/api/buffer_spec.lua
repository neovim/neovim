...
describe('api/buf', function()
  ...
  describe('nvim_buf_get_prompt_text', function()
    it('works', function()
      command('new')
      api.nvim_set_option_value('buftype', 'prompt', { buf = 0 })
      eq('', api.nvim_buf_get_prompt_text(0, {}))
      api.nvim_input('iasdf')
      eq('asdf', api.nvim_buf_get_prompt_text(0, {}))
      api.nvim_input('<esc>dd')
      eq('', api.nvim_buf_get_prompt_text(0, {}))
      api.nvim_input('iasdf2')
      eq('asdf2', api.nvim_buf_get_prompt_text(0, {}))
    end)

    it('throws error when calling on non prompt buffer', function()
      command('new')
      api.nvim_set_option_value('buftype', 'prompt', { buf = 0 })
      eq('', api.nvim_buf_get_prompt_text(0, {}))
      api.nvim_input('iasdf')
      api.nvim_set_option_value('buftype', '', { buf = 0 })
      eq(false, pcall(api.nvim_buf_get_prompt_text, 0, {}))
    end)
  end)
end)
