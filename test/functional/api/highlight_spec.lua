...
describe('API: get highlight', function()
  ...
  it('can set default link even if link is set', function()
    api.nvim_set_hl(0, 'From', { link = 'To1' })
    api.nvim_set_hl(0, 'From', { link = 'To2', default = true })
    eq({ link = 'To1' }, api.nvim_get_hl(0, { name = 'From' }))
    command('hi clear')
    eq({ link = 'To2' }, api.nvim_get_hl(0, { name = 'From' }))
  end)

  it('does not overwrite default link', function()
    api.nvim_set_hl(0, 'From', { link = 'To1', default = true })
    api.nvim_set_hl(0, 'From', { link = 'To2', default = true })
    eq({ link = 'To1', default = true }, api.nvim_get_hl(0, { name = 'From' }))
    command('hi clear')
    eq({ link = 'To1' }, api.nvim_get_hl(0, { name = 'From' }))
  end)
end)
