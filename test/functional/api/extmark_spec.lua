...
describe('API/extmarks', function()
  ...
  it('can end extranges past final newline using end_col = 0', function()
    ...
    eq('end_col value outside range', pcall_err(set_extmark, ns, marks[2], 0, 0, { end_col = 1, end_line = 1 }))
  end)
  ...
  it('get_marks works when mark col > upper col', function()
    ...
    eq({ { marks[1], 0, 4 }, { marks[2], 1, 1 }, { marks[3], 2, 0 } }, get_extmarks(ns, { 0, 3 }, { 2, 0 }))
  end)
