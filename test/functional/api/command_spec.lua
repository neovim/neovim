...
describe('nvim_create_user_command', function()
  ...
  it('addr option allows ranges without explicit range option', function()
    feed([[:call nvim_create_user_command('Test2', 'echo "hello"', #{addr: 'other'})<CR>]])
    eq('hello', n.exec_capture('1,2Test2'))
  end)
end)
