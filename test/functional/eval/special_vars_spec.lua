...
describe('Special values', function()
  ...
  it('associate v:none to NIL through msgpack', function()
    eq(NIL, eval('v:none'))
  end)

  it('work with string() properly', function()
    eq('v:null', funcs.string(eval('v:null')))
    eq('v:null', funcs.string(eval('v:none')))
