...
describe('msgpack*() functions', function()
  ...
  local big_obj = {
    ...
    1436711451,
    40,
    { file = '/home/zyx/.nvim/shada/main.shada' },
    8,
    1436711391,
    8,
    { file = '' },
    ...
    1436700940,
    30,
    { 0, "call mkdir('/tmp/tty/tty')" },
    4,
    1436701355,
    35,
    { 0, "call mkdir('/tmp/tty/tty', 'p')" },
    4,
    1436701368,
    24,
    { 0, "call mkdir('/', 'p')" },
    ...
    1436701375,
    26,
    { 0, "call mkdir('/tty/tty')" },
    4,
    1436701383,
    30,
    { 0, "call mkdir('/tty/tty/tty')" },
    4,
    1436701407,
    35,
    { 0, "call mkdir('/usr/tty/tty', 'p')" },
    4,
    1436701666,
    35,
    { 0, "call mkdir('/tty/tty/tty', 'p')" },
    4,
    1436708101,
    25,
    { 0, 'echo msgpackdump([1])' },
    4,
    1436708966,
    6,
    { 0, 'cq' },
    ...
    1436709606,
    25,
    { 0, 'echo msgpackdump([5])' },
    4,
    1436709610,
    26,
    { 0, 'echo msgpackdump([10])' },
    4,
    1436709615,
    31,
    { 0, 'echo msgpackdump([5, 5, 5])' },
    4,
    1436709618,
    35,
    { 0, 'echo msgpackdump([5, 5, 5, 10])' },
    4,
    1436709634,
    57,
    {
    ...
    1436711196,
    45,
    { 0, "let lengths = map(mpack[:], 'len(v:val)')" },
    4,
    1436711206,
    16,
    { 0, 'echo lengths' },
    ...
    {
      0,
      ('let sum = len(lengths) - 1 | call map(copy(lengths), ' .. '\'extend(g:, {"sum": sum + v:val})\')'),
    },
    4,
    1436711245,
    12,
    ...
    1436711404,
    41,
    { 0, "let mpack = readfile('/tmp/foo', 'b')" },
    4,
    1436711408,
    41,
    { 0, 'let shada_objects=msgpackparse(mpack)' },
    4,
    1436711415,
    22,
    { 0, 'echo shada_objects' },
    4,
    1436711451,
    30,
    { 0, 'e ~/.nvim/shada/main.shada' },
    4,
    1436711454,
    6,
    { 0, 'qa' },
    ...
    1436711443,
    38,
    { hlsearch = 1, pat = 'aontsuesan', smartcase = 1 },
    2,
    0,
    31,
    { islast = 0, pat = '', smartcase = 1, sub = 1 },
    3,
    0,
    3,
    { '' },
...
describe('msgpackparse() function', function()
  ...
  it('restores MAP with duplicate STR keys as special dictionary', function()
    ...
    eq(
      { { _TYPE = {}, _VAL = { { { _TYPE = {}, _VAL = { 'a' } }, '' }, { { _TYPE = {}, _VAL = { 'a' } }, '' } } } },
      eval 'parsed'
    )
    eq(1, eval 'g:parsed[0]._TYPE is v:msgpack_types.map')
  ...
  it('fails when called with no arguments', function()
    eq('Vim(call):E119: Not enough arguments for function: msgpackparse', exc_exec 'call msgpackparse()')
  end)

  it('fails when called with two arguments', function()
    eq('Vim(call):E118: Too many arguments for function: msgpackparse', exc_exec 'call msgpackparse(["", ""], 1)')
  end)

  it('fails to parse a string', function()
    eq(
      'Vim(call):E686: Argument of msgpackparse() must be a List',
      exc_exec 'call msgpackparse("abcdefghijklmnopqrstuvwxyz")'
    )
  end)

  it('fails to parse a number', function()
    eq('Vim(call):E686: Argument of msgpackparse() must be a List', exc_exec 'call msgpackparse(127)')
  end)
  ...
  it('fails to parse a funcref', function()
    eq('Vim(call):E686: Argument of msgpackparse() must be a List', exc_exec 'call msgpackparse(function("tr"))')
  end)
  ...
  it('fails to parse a float', function()
    eq('Vim(call):E686: Argument of msgpackparse() must be a List', exc_exec 'call msgpackparse(0.0)')
  end)
end)
...
describe('msgpackdump() function', function()
  ...
  it('fails when called with no arguments', function()
    eq('Vim(call):E119: Not enough arguments for function: msgpackdump', exc_exec 'call msgpackdump()')
  end)

  it('fails when called with two arguments', function()
    eq('Vim(call):E118: Too many arguments for function: msgpackdump', exc_exec 'call msgpackdump(["", ""], 1)')
  end)
  ...
  it('fails to dump a number', function()
    eq('Vim(call):E686: Argument of msgpackdump() must be a List', exc_exec 'call msgpackdump(127)')
  end)
  ...
  it('fails to dump a funcref', function()
    eq('Vim(call):E686: Argument of msgpackdump() must be a List', exc_exec 'call msgpackdump(function("tr"))')
  end)
  ...
  it('fails to dump a float', function()
    eq('Vim(call):E686: Argument of msgpackdump() must be a List', exc_exec 'call msgpackdump(0.0)')
  end)

  it('fails to dump special value', function()
    for _, val in ipairs { 'v:true', 'v:false', 'v:null' } do
      eq('Vim(call):E686: Argument of msgpackdump() must be a List', exc_exec('call msgpackdump(' .. val .. ')'))
    end
  end)
