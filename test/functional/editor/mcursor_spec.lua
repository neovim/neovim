...
describe('multicursor', function()
  ...
  describe('Q', function()
    ...
    it("clearing mcursors keeps 'mcfollow'; Q disables it", function()
      cursors({ 'aaa', 'bbb', 'ccc' }, 'QjQ')
      feed('q=')
      clear_cursors()
      eq(true, api.nvim_get_option_value('mcfollow', {}))
      feed('Q')
      eq(false, api.nvim_get_option_value('mcfollow', {}))
      eq(1, ncursors())
      feed('l')
      eq(1, ncursors())
  ...
  describe('q= (follow-mode)', function()
    it("'mcfollow' option", function()
      -- :setlocal is the same as "q=".
      cursors({ 'abcd', 'efgh' }, 'Qj')
      command('setlocal mcfollow')
      feed('lx')
      ...
      clear_cursors()
      command('setlocal nomcfollow')
      command('let g:optionset = 0 | autocmd OptionSet mcfollow let g:optionset += 1')
    ...
    it("implicit exit (cursors deduped) keeps 'mcfollow'; Q disables it", function()
      cursors({ 'aaa', 'bbb', 'ccc' })
      eq(2, ncursors())
      feed('q=')
