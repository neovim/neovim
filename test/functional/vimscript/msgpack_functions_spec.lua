...
describe('msgpackparse() function', function()
  ...
  it('fails to parse a number', function()
    eq('Vim(call):E899: Argument of msgpackparse() must be a List or Blob', exc_exec('call msgpackparse(127)'))
  end)

  it('fails to parse a dictionary', function()
    eq('Vim(call):E899: Argument of msgpackparse() must be a List or Blob', exc_exec('call msgpackparse({})'))
  end)
  ...
  it('fails to parse a float', function()
    eq('Vim(call):E899: Argument of msgpackparse() must be a List or Blob', exc_exec('call msgpackparse(0.0)'))
  end)
...
describe('msgpackdump() function', function()
  ...
  it('fails when called with three arguments', function()
    eq('Vim(call):E118: Too many arguments for function: msgpackdump', exc_exec('call msgpackdump(["", ""], 1, 2)'))
  end)
