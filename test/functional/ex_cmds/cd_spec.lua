...
describe(':cd :tcd :lcd', function()
  ...
  local function testCdFamily(cmd)
    local wd = function()
      return eval('getcwd()')
    end
  ...
  -- This gets stuck as well:
  -- it('sets to local directory for the program, tabs and windows', testCdFamily('cd'))
end)
