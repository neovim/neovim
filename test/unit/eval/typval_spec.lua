      ...
      describe('add()/remove()', function()
        itp('works', function()
          ...
          eq(
            ...
            end, 'E685: Internal error: hash_add()')
          )
          alloc_log:clear()
    ...
    describe('indexing', function()
      ...
      describe('get_string()', function()
        ...
        itp('works', function()
          ...
          eq(
            ...
            end, 'E731: using Dictionary as a String'))
          )
          ...
          eq(
            ...
            end, 'E806: using Float as a String'))
          )
        end)
      ...
      describe('get_callback()', function()
        ...
        itp('works', function()
          ...
          local d = dict(lua_d)
          eq(lua_d, dct2tbl(d))
          eq({ { type = 'fref', fref = 'tr' }, true }, { tv_dict_get_callback(d, nil, 0) })
          ...
          eq(
            { { type = 'pt', fref = 'tr', pt = { [type_key] = func_type, value = 'tr', args = { 'a', 'b' } } }, true },
  ...
  describe('tv', function()
    ...
    describe('check_lock()', function()
      ...
      itp('works', function()
        ...
        eq(true, tv_check_lock(lib.VAR_LOCKED, nil, lib.kTVCstring, 'E741: Value is locked: Unknown'))
        eq(true, tv_check_lock(lib.VAR_FIXED, 'test', lib.kTVCstring, 'E742: Cannot change value of test'))
      end)
    end)
    describe('equal()', function()
      itp('compares empty and NULL lists correctly', function()
          ...
          do
            ...
            eq(
              ...
              check_emsg(function()
                ...
                if tv.v_type == lib.VAR_NUMBER or tv.v_type == lib.VAR_SPECIAL or tv.v_type == lib.VAR_BOOL then
                  eq(buf, res)
                else
                  neq(buf, res)
                end
