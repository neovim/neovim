...
describe('mbyte', function()
  ...
  describe('utfc_ptr2char_len', function()
    ...
    itp('5+-byte sequences', function()
      ...
      eq(
        0x007f,
        mbyte.utfc_ptr2char_len(to_string({ 0x7f, 0xcc, 0x80, 0xcc, 0x81, 0xcc, 0x82 }), pcc, 7)
      )
      eq(0x0300, pcc[0])
      eq(0x0301, pcc[1])
      eq(0x0302, pcc[2])
      ...
      eq(
        ...
        mbyte.utfc_ptr2char_len(
          to_string({ 0x7f, 0xcc, 0x80, 0xcc, 0x81, 0xcc, 0x82, 0xcc, 0x83 }),
          pcc,
          9
        )
      )
      ...
      eq(
        0x007f,
        mbyte.utfc_ptr2char_len(
          to_string({ 0x7f, 0xcc, 0x80, 0xcc, 0x81, 0xcc, 0x82, 0xcc, 0x83, 0xcc, 0x84 }),
          pcc,
          11
        )
      )
      ...
      eq(
        0x100000,
        mbyte.utfc_ptr2char_len(
          to_string({ 0xf4, 0x80, 0x80, 0x80, 0xe1, 0xaa, 0xb0, 0xcc, 0x81 }),
          pcc,
          9
        )
      )
