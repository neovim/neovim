...
--- @field print_color fun(any)
--- @field screen_sb_clear fun(any)
--- @field screen_sb_popline fun(any)
--- @field screen_sb_pushline fun(any)
--- @field selection_query fun(any)
--- @field selection_set fun(any)
--- @field state_erase fun(any)
--- @field state_movecursor fun(any)
--- @field state_moverect fun(any)
--- @field state_pos fun(any)
--- @field state_putglyph fun(any)
--- @field state_sb_clear fun(any)
--- @field state_scrollrect fun(any)
--- @field state_setlineinfo fun(any)
--- @field state_setpenattr fun(any)
--- @field state_settermprop fun(any)
--- @field term_output fun(any)
...
--- @field vterm_output_set_callback fun(any, any, any)
--- @field vterm_parser_set_callbacks fun(any, any, any):any
--- @field vterm_screen_convert_color_to_rgb fun(any, any)
--- @field vterm_screen_enable_altscreen fun(any, any)
--- @field vterm_screen_enable_reflow fun(any, any)
--- @field vterm_screen_get_attrs_extent fun(any, any, any, any)
--- @field vterm_screen_get_cell fun(any, any, any)
...
--- @field vterm_screen_reset fun(any, any)
--- @field vterm_screen_set_callbacks fun(any, any, any)
--- @field vterm_set_size fun(any, any, any)
...
--- @field vterm_state_get_penattr fun(any, any, any)
--- @field vterm_state_reset fun(any, any)
--- @field vterm_state_set_bold_highbright fun(any, any)
--- @field vterm_state_set_callbacks fun(any, any, any)
--- @field vterm_state_set_selection_callbacks fun(any, any, any, any, any)
--- @field vterm_state_set_unrecognised_fallbacks fun(any, any, any)
...
local function expect(expected)
  ...
  vim.fs.rm(t.paths.vterm_test_file)
  t.eq(expected .. '\n', actual)
end
...
local function screen_cell(row, col, expected, screen)
  ...
  local f = assert(io.open(t.paths.vterm_test_file, 'rb'))
  actual = actual .. tostring(f:read('*a'))
  f:close()
  ...
  f = assert(io.open(t.paths.vterm_test_file, 'rb'))
  actual = actual .. tostring(f:read('*a'))
  f:close()
  vim.fs.rm(t.paths.vterm_test_file, { force = true })
...
local function strpe_modifiers(input_mod)
  local mod = t.ffi.new('VTermModifier')
  if input_mod == 'C' then
...
local function mousemove(row, col, input_mod, vt)
  local mod = strpe_modifiers(input_mod)
  vterm.vterm_mouse_move(vt, row, col, mod)
end

local function mousebtn(press, button, input_mod, vt)
  local mod = strpe_modifiers(input_mod)
...
describe('vterm', function()
  ...
  itp('12state_scroll', function()
    ...
    -- DECRQSS on DECSTBM
    push('\x1bP$qr\x1b\\', vt)
    expect('output 1b,50,31,24,72,33,3b,31,30,72,1b,5c')

    -- DECRQSS on DECSLRM
    push('\x1bP$qs\x1b\\', vt)
    expect('output 1b,50,31,24,72,31,30,3b,34,30,73,1b,5c')
  ...
  itp('13state_edit', function()
    ...
    expect('output 1b,50,31,24,72,32,22,71,1b,5c')
  ...
  itp('15state_mode', function()
    ...
    push('\x1b[?6h', vt)
    push('\x1b[?6$p', vt)
    expect('output 1b,5b,3f,36,3b,31,24,79')
    push('\x1b[?6l', vt)
    push('\x1b[?6$p', vt)
    expect('output 1b,5b,3f,36,3b,32,24,79')
  ...
  itp('17state_mouse', function()
    ...
    push('\x1b[?1000$p', vt)
    expect('output 1b,5b,3f,31,30,30,30,3b,32,24,79')
    push('\x1b[?1002$p', vt)
    expect('output 1b,5b,3f,31,30,30,32,3b,32,24,79')
    push('\x1b[?1003$p', vt)
    expect('output 1b,5b,3f,31,30,30,33,3b,32,24,79')
    ...
    mousemove(0, 0, 0, vt)
    mousebtn('d', 1, 0, vt)
    expect('output 1b,5b,4d,20,21,21')

    -- Release 1
    mousebtn('u', 1, 0, vt)
    expect('output 1b,5b,4d,23,21,21')

    -- Ctrl-Press 1
    mousebtn('d', 1, 'C', vt)
    expect('output 1b,5b,4d,30,21,21')
    mousebtn('u', 1, 'C', vt)
    expect('output 1b,5b,4d,33,21,21')

    -- Button 2
    mousebtn('d', 2, 0, vt)
    expect('output 1b,5b,4d,21,21,21')
    mousebtn('u', 2, 0, vt)
    expect('output 1b,5b,4d,23,21,21')

    -- Position
    mousemove(10, 20, 0, vt)
    mousebtn('d', 1, 0, vt)
    expect('output 1b,5b,4d,20,35,2b')

    mousebtn('u', 1, 0, vt)
    expect('output 1b,5b,4d,23,35,2b')
    mousemove(10, 21, 0, vt)
    -- no output

    -- Wheel events
    mousebtn('d', 4, 0, vt)
    expect('output 1b,5b,4d,60,36,2b')
    mousebtn('d', 4, 0, vt)
    expect('output 1b,5b,4d,60,36,2b')
    mousebtn('d', 5, 0, vt)
    expect('output 1b,5b,4d,61,36,2b')
    mousebtn('d', 6, 0, vt)
    expect('output 1b,5b,4d,62,36,2b')
    mousebtn('d', 7, 0, vt)
    expect('output 1b,5b,4d,63,36,2b')

    -- DECRQM on mouse button mode
    push('\x1b[?1000$p', vt)
    expect('output 1b,5b,3f,31,30,30,30,3b,31,24,79')
    push('\x1b[?1002$p', vt)
    expect('output 1b,5b,3f,31,30,30,32,3b,32,24,79')
    push('\x1b[?1003$p', vt)
    expect('output 1b,5b,3f,31,30,30,33,3b,32,24,79')
    ...
    mousemove(5, 5, 0, vt)
    mousebtn('d', 1, 0, vt)
    expect('output 1b,5b,4d,20,26,26')
    mousemove(5, 6, 0, vt)
    expect('output 1b,5b,4d,40,27,26')
    mousemove(6, 6, 0, vt)
    expect('output 1b,5b,4d,40,27,27')
    mousemove(6, 6, 0, vt)
    -- no output
    mousebtn('u', 1, 0, vt)
    expect('output 1b,5b,4d,23,27,27')
    mousemove(6, 7, 0, vt)
    -- no output
    ...
    expect('output 1b,5b,3f,31,30,30,30,3b,32,24,79')
    push('\x1b[?1002$p', vt)
    expect('output 1b,5b,3f,31,30,30,32,3b,31,24,79')
    push('\x1b[?1003$p', vt)
    expect('output 1b,5b,3f,31,30,30,33,3b,32,24,79')
    ...
    mousemove(6, 8, 0, vt)
    expect('output 1b,5b,4d,43,29,27')
    ...
    expect('output 1b,5b,3f,31,30,30,32,3b,32,24,79')
    push('\x1b[?1003$p', vt)
    expect('output 1b,5b,3f,31,30,30,33,3b,31,24,79')

    -- Bounds checking
    mousemove(300, 300, 0, vt)
    expect('output 1b,5b,4d,43,ff,ff')
    mousebtn('d', 1, 0, vt)
    expect('output 1b,5b,4d,20,ff,ff')
    mousebtn('u', 1, 0, vt)
    expect('output 1b,5b,4d,23,ff,ff')

    -- DECRQM on standard encoding mode
    push('\x1b[?1005$p', vt)
    expect('output 1b,5b,3f,31,30,30,35,3b,32,24,79')
    push('\x1b[?1006$p', vt)
    expect('output 1b,5b,3f,31,30,30,36,3b,32,24,79')
    push('\x1b[?1015$p', vt)
    expect('output 1b,5b,3f,31,30,31,35,3b,32,24,79')

    -- UTF-8 extended encoding mode
    -- 300 + 32 + 1 = 333 = U+014d = \xc5\x8d
    push('\x1b[?1005h', vt)
    mousebtn('d', 1, 0, vt)
    expect('output 1b,5b,4d,20,c5,8d,c5,8d')
    mousebtn('u', 1, 0, vt)
    expect('output 1b,5b,4d,23,c5,8d,c5,8d')

    -- DECRQM on UTF-8 extended encoding mode
    push('\x1b[?1005$p', vt)
    expect('output 1b,5b,3f,31,30,30,35,3b,31,24,79')
    push('\x1b[?1006$p', vt)
    expect('output 1b,5b,3f,31,30,30,36,3b,32,24,79')
    push('\x1b[?1015$p', vt)
    expect('output 1b,5b,3f,31,30,31,35,3b,32,24,79')
    ...
    push('\x1b[?1006h', vt)
    mousebtn('d', 1, 0, vt)
    expect('output 1b,5b,3c,30,3b,33,30,31,3b,33,30,31,4d')
    mousebtn('u', 1, 0, vt)
    expect('output 1b,5b,3c,30,3b,33,30,31,3b,33,30,31,6d')

    -- DECRQM on SGR extended encoding mode
    push('\x1b[?1005$p', vt)
    expect('output 1b,5b,3f,31,30,30,35,3b,32,24,79')
    push('\x1b[?1006$p', vt)
    expect('output 1b,5b,3f,31,30,30,36,3b,31,24,79')
    push('\x1b[?1015$p', vt)
    expect('output 1b,5b,3f,31,30,31,35,3b,32,24,79')
    ...
    push('\x1b[?1015h', vt)
    mousebtn('d', 1, 0, vt)
    expect('output 1b,5b,30,3b,33,30,31,3b,33,30,31,4d')
    mousebtn('u', 1, 0, vt)
    expect('output 1b,5b,33,3b,33,30,31,3b,33,30,31,4d')
    ...
    expect('output 1b,5b,3f,31,30,30,36,3b,32,24,79')
    push('\x1b[?1015$p', vt)
    expect('output 1b,5b,3f,31,30,31,35,3b,31,24,79')
    ...
    expect('settermprop 8 2')
    mousebtn('d', 1, 0, vt)
    expect('output 1b,5b,3c,30,3b,31,3b,31,4d')
  end)
  ...
  itp('18state_termprops', function()
    ...
    expect('settermprop 1 true')
    push('\x1b[?25$p', vt)
    expect('output 1b,5b,3f,32,35,3b,31,24,79')
    push('\x1b[?25l', vt)
    expect('settermprop 1 false')
    push('\x1b[?25$p', vt)
    expect('output 1b,5b,3f,32,35,3b,32,24,79')

    -- Cursor blink
    push('\x1b[?12h', vt)
    expect('settermprop 2 true')
    push('\x1b[?12$p', vt)
    expect('output 1b,5b,3f,31,32,3b,31,24,79')
    push('\x1b[?12l', vt)
    expect('settermprop 2 false')
    push('\x1b[?12$p', vt)
    expect('output 1b,5b,3f,31,32,3b,32,24,79')
