...
let test_values = {
      ...
      "\ "		['xxx', 'menu,,,longest,']],
      \ 'completepopup': [['', 'height:13', 'width:20', 'width:10,height:234',
      \			'border:single', 'border:none', 'align:item', 'align:menu',
      \			'height:10,width:20,border:rounded,align:menu'],
      \			['xxx', 'xxx:99', 'height:yes', 'width:no',
      \			'border:', 'border:xxx', 'border:on',
      \			'align:', 'align:xxx']],
      ...
      \ 'previewpopup': [['', 'height:13', 'width:20', 'width:10,height:234',
      \			'border:single', 'border:none',
      \			'height:10,width:20,border:rounded'],
      \			['xxx', 'xxx:99', 'height:yes', 'width:no',
      \			'border:', 'border:xxx', 'border:on']],
