...
func Test_null_list()
  let l = v:_null_list
  call assert_equal('', join(v:_null_list))
  ...
  " call assert_equal(0, insert(v:_null_list, 2, -1))
  call assert_fails('call insert(l, 2, -1)', 'E742:')
  call assert_equal(0, min(l))
  call assert_equal(0, max(l))
  " call assert_equal(0, remove(v:_null_list, 0, 2))
  call assert_fails('call remove(l, 0, 2)', 'E742:')
  call assert_equal([], repeat(l, 2))
  " call assert_equal(0, reverse(v:_null_list))
  " call assert_equal([], reverse(l))
  " call assert_equal(0, sort(v:_null_list))
  " call assert_equal([], sort(l))
  call assert_equal('[]', string(l))
  call assert_fails('call extend(v:_null_list, v:_null_list)', 'E742:')
...
func Test_null_dict()
  ...
  call assert_equal([], items(v:_null_dict))
  call assert_equal([], items(d))
  call assert_equal([], keys(v:_null_dict))
  call assert_equal([], keys(d))
  call assert_equal([], values(v:_null_dict))
  ...
  call assert_equal(0, remove(v:_null_dict, 'k'))
  " call assert_fails("call remove(d, 'k')", 'E716:')
  call assert_equal('{}', string(d))
  call assert_fails('call extend(v:_null_dict, v:_null_dict)', 'E742:')
