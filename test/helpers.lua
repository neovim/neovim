...
local nvim_helpers = require('src.nvim.lib.helpers')
...
return {
  ...
  uname = uname,
  tmpname = tmpname,
  map = nvim_helpers.map,
  filter = nvim_helpers.filter,
  glob = glob,
  check_cores = check_cores,
  hasenv = hasenv,
  which = which,
  shallowcopy = nvim_helpers.shallowcopy,
  concat_tables = nvim_helpers.concat_tables,
  dedent = nvim_helpers.dedent,
}
