...
function(BuildLibuv)
  cmake_parse_arguments(_libuv
    "BUILD_IN_SOURCE"
    "TARGET"
    "PATCH_COMMAND;CONFIGURE_COMMAND;BUILD_COMMAND;INSTALL_COMMAND;DOWNLOAD_COMMAND;GIT_REPOSITORY;GIT_TAG;UPDATE_COMMAND"
    ${ARGN})
  ...
  ExternalProject_Add(${_libuv_TARGET}
    ...
    UPDATE_COMMAND ${_libuv_UPDATE_COMMAND}
...
elseif(WIN32)
  ...
  BuildLibUv(BUILD_IN_SOURCE
    ...
    GIT_REPOSITORY ${LIBUV_URL}
    GIT_TAG ${LIBUV_TAG}
    UPDATE_COMMAND ${CMAKE_COMMAND} -E echo "Skip Update")
